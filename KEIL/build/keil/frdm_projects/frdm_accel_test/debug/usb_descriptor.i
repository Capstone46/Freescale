#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_descriptor.c"
...
#line 25 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_descriptor.c"
...
#line 26 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_descriptor.c"
...
#line 27 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_descriptor.c"
...
#line 28 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_descriptor.c"
...
const USB_ENDPOINTS usb_desc_ep = { (1),
                                      {(1),
                                       (0x03),
                                       (1),
                                       (8),
...
uint_8 const g_device_descriptor[(18)] =
{
   (18),                
   (1),                 
   0x00, 0x02,                            
...
uint_8 const g_config_descriptor[(34)] =
{
   (9),   
   (2),   
   (34), 0x00,  
...
uint_8 const g_report_descriptor[(52)] =
{
   0x05, 0x01,    
   0x09, 0x02,    
   0xA1, 0x01,    
...
uint_16 const g_std_desc_size[(8)+1] =
                                    {0,
                                     (18),
                                     (34),
                                     0,  
...
uint_8_ptr const g_std_descriptors[(8)+1] =
                                            {
                                                0,
...
uint_8 const g_string_desc_size[(3)+1] =
                                    {sizeof(USB_STR_0),
                                     sizeof(USB_STR_1),
                                     sizeof(USB_STR_2),
                                     sizeof(USB_STR_n)
...
uint_8_ptr const g_string_descriptors[(3)+1] =
										  {
...
uint_8 const g_valid_config_values[(1)+1]={0,1};



 
static uint_8 g_alternate_interface[(1)];
