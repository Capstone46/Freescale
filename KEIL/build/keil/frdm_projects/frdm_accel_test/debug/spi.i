...
#line 12 "..\\..\\..\\..\\src\\drivers\\spi\\spi.c"



 
static SPI_CALLBACK     volatile pCallbackSPI0=0;
static SPI_CALLBACK     volatile pCallbackSPI1=0;
static SPI_SSCALLBACK   volatile pCallbackSS0=0;
static SPI_SSCALLBACK   volatile pCallbackSS1=0;
...
{     
  ...
  { 
    pCallbackSPI0 = pC1; 
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_SPI0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_SPI0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_SPI0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_SPI0)-16)%4)<<3)+6)); }; 
  }

   
  if (pC2 != 0) { 
    pCallbackSS0 = pC2; 
    pCallbackSS0 (SS_INIT);      
  }
  
   
  ((((SPI_MemMapPtr)0x40076000u))->C1)      = spi.C1;         
  ((((SPI_MemMapPtr)0x40076000u))->C2)      = spi.C2;         
  ((((SPI_MemMapPtr)0x40076000u))->BR)      = spi.BR;         
  ((((SPI_MemMapPtr)0x40076000u))->ML)      = spi.ML;         
  ((((SPI_MemMapPtr)0x40076000u))->MH)      = spi.MH;         
  ((((SPI_MemMapPtr)0x40076000u))->C1) |= 0x40u;     
...
{     
  ...
  { 
    pCallbackSPI1 = pC1; 
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_SPI1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_SPI1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_SPI1)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_SPI1)-16)%4)<<3)+6)); }; 
  }

   
  if (pC2 != 0) { 
    pCallbackSS1 = pC2; 
    pCallbackSS1 (SS_INIT);      
  }
  
   
  ((((SPI_MemMapPtr)0x40077000u))->C1)      = spi.C1;         
  ((((SPI_MemMapPtr)0x40077000u))->C2)      = spi.C2;         
  ((((SPI_MemMapPtr)0x40077000u))->C3)      = spi.C3;         
  ((((SPI_MemMapPtr)0x40077000u))->BR)      = spi.BR;         
  ((((SPI_MemMapPtr)0x40077000u))->ML)      = spi.ML;         
  ((((SPI_MemMapPtr)0x40077000u))->MH)      = spi.MH;         
  ((((SPI_MemMapPtr)0x40077000u))->C1) |= 0x40u;     
}
...
{
  while (!(((((SPI_MemMapPtr)0x40076000u))->S) & 0x20u));    
  { register uint16 tmp = (uint16)txdata; ((((SPI_MemMapPtr)0x40076000u))->DL) = (uint8)(tmp & 0x00FF); ((((SPI_MemMapPtr)0x40076000u))->DH) = (uint8)((tmp & 0xFF00)>>8); };      
  while(!(((((SPI_MemMapPtr)0x40076000u))->S) & 0x80u));      
  return (((uint16)((((SPI_MemMapPtr)0x40076000u))->DL)|(uint16)(((((SPI_MemMapPtr)0x40076000u))->DH)<<8)));    
}

uint16 SPI1_TxRxWord(uint16 txdata)
{
  while (!(((((SPI_MemMapPtr)0x40077000u))->S) & 0x20u));    
  { register uint16 tmp = (uint16)txdata; ((((SPI_MemMapPtr)0x40077000u))->DL) = (uint8)(tmp & 0x00FF); ((((SPI_MemMapPtr)0x40077000u))->DH) = (uint8)((tmp & 0xFF00)>>8); };      
  while(!(((((SPI_MemMapPtr)0x40077000u))->S) & 0x80u));      
  return (((uint16)((((SPI_MemMapPtr)0x40077000u))->DL)|(uint16)(((((SPI_MemMapPtr)0x40077000u))->DH)<<8)));    
}
...
void SPI0_CommWord(uint16 *txdata, uint16 txcnt,uint16 *rxdata, uint16 rxcnt)
{
  ...
  if (pCallbackSS0 != (SPI_SSCALLBACK)0) 
  {  
    pCallbackSS0 (SS_CLEAR);       
  }
  if (txdata != 0) {            
    for (i=0; i<txcnt; i++) {      
      SPI0_TxRxWord(*txdata);      
      txdata++;                    
    }
  }
...
void SPI1_CommWord(uint16 *txdata, uint16 txcnt,uint16 *rxdata, uint16 rxcnt)
{
  ...
  if (pCallbackSS1 != (SPI_SSCALLBACK)0) 
  {  
    pCallbackSS1 (SS_CLEAR);       
  }

  if (txdata != 0) {            
    for (i=0; i<txcnt; i++) {      
      SPI1_TxRxWord(*txdata);      
      txdata++;                    
    }
  }
...
void spi0_isr (void)
{
  ...
  if (pCallbackSPI0 != (SPI_CALLBACK)0) 
  {  

    tmp = ((((SPI_MemMapPtr)0x40076000u))->S) & (0x80u|0x20u|0x40u|
                    0x10u);
    ...
    if(tmp & (0x40u))
      ...
      { ((((SPI_MemMapPtr)0x40076000u))->S)=((((((SPI_MemMapPtr)0x40076000u))->S)&~0x40u)|(0x1<<6)); };   }
    
     
    if(tmp & (0x10u)) 
      {pCallbackSPI0 (SPI0_CALLBACK,FAULT_CALLBACK);
      { ((((SPI_MemMapPtr)0x40076000u))->S)=((((((SPI_MemMapPtr)0x40076000u))->S)&~0x10u)|(0x1<<4)); };   }
  }
}
...
void spi1_isr (void)
{
  ...
  if (pCallbackSPI1 != (SPI_CALLBACK)0) 
  {  

    tmp = ((((SPI_MemMapPtr)0x40077000u))->S) & (0x80u|0x20u|0x40u|
                    0x10u);
    ...
    if(tmp & (0x40u))
      ...
      { ((((SPI_MemMapPtr)0x40077000u))->S)=((((((SPI_MemMapPtr)0x40077000u))->S)&~0x40u)|(0x1<<6)); };   }
    
     
    if(tmp & (0x10u)) 
      {pCallbackSPI1 (SPI1_CALLBACK,FAULT_CALLBACK);
      { ((((SPI_MemMapPtr)0x40077000u))->S)=((((((SPI_MemMapPtr)0x40077000u))->S)&~0x10u)|(0x1<<4)); };   }
  }
}
