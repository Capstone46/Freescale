#line 1 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio.c"
...
#line 14 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio.c"
...
#line 15 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio.c"
...
static tFLEXIO_CALLBACK_DESC_INT volatile flexio_CallBackDesc[5];
...
void FLEXIO_Init(tFLEXIO flexio, uint8 ip, FLEXIO_CALLBACK pCallback)
{
  ...
  { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_UART0_FLEXIO)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_UART0_FLEXIO)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_UART0_FLEXIO)-16)%4)<<3)+6))); };

  for(i=0; i< 5; i++)
    flexio_CallBackDesc[i].pCallBack = 0;
  ...
  ((((FLEXIO_MemMapPtr)0x4005F000u))->CTRL)     = flexio.CTRL;
}
...
int32_t FLEXIO_RegisterCallback(tFLEXIO_CALLBACK_DESC *pCallBackDesc, uint32 high_priority)
{
  ...
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMSTAT) = pCallBackDesc->TIMERFLG_MASK;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSTAT) = pCallBackDesc->SHIFTFLG_MASK;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTERR) = pCallBackDesc->SHIFTERR_MASK;
...
{
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSIEN) = flexio_shifter.SHIFTSIEN<<0;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTEIEN) = flexio_shifter.SHIFTEIEN<<0;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSDEN) = flexio_shifter.SHIFTSDEN<<0;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[0]) = flexio_shifter.SHIFTCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[0]) = flexio_shifter.SHIFTCTL;
}
...
{
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSIEN) = flexio_shifter.SHIFTSIEN<<1;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTEIEN) = flexio_shifter.SHIFTEIEN<<1;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSDEN) = flexio_shifter.SHIFTSDEN<<1;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[1]) = flexio_shifter.SHIFTCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[1]) = flexio_shifter.SHIFTCTL;
}
...
{
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSIEN) = flexio_shifter.SHIFTSIEN<<2;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTEIEN) = flexio_shifter.SHIFTEIEN<<2;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSDEN) = flexio_shifter.SHIFTSDEN<<2;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[2]) = flexio_shifter.SHIFTCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[2]) = flexio_shifter.SHIFTCTL;
}
...
{
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSIEN) = flexio_shifter.SHIFTSIEN<<3;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTEIEN) = flexio_shifter.SHIFTEIEN<<3;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSDEN) = flexio_shifter.SHIFTSDEN<<3;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[3]) = flexio_shifter.SHIFTCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[3]) = flexio_shifter.SHIFTCTL;
}
...
{
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x0])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x0])&~0xFFFFu)|(u32TimerComVal<<0)); };;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) = flexio_timer.TIMIEN<<0;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[0]) = flexio_timer.TIMCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[0]) = flexio_timer.TIMCTL;
}
...
{
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x1])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x1])&~0xFFFFu)|(u32TimerComVal<<0)); };;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) = flexio_timer.TIMIEN<<1;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[1]) = flexio_timer.TIMCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[1]) = flexio_timer.TIMCTL;
}
...
{
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x2])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[0x2])&~0xFFFFu)|(u32TimerComVal<<0)); };;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) = flexio_timer.TIMIEN<<2;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[2]) = flexio_timer.TIMCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[2]) = flexio_timer.TIMCTL;
}
...
{
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) = flexio_timer.TIMIEN<<3;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[3]) = flexio_timer.TIMCFG;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[3]) = flexio_timer.TIMCTL;
}
...
void flexio_isr (void)
{
  if (flexio_CallBackDesc[0].pCallBack) 
  {
    uint32_t timerStat_mask = ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMSTAT);
    uint32_t shifterStat_mask = ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSTAT);
    uint32_t shifterErr_mask = ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTERR);
    uint32_t i = 0;
    uint32_t callbacksMask;

    
    timerStat_mask &= (((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) & 0xFu);
    shifterStat_mask &= (((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSIEN) & 0xFu);
    shifterErr_mask &= (((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTEIEN) & 0xFu);

    callbacksMask =  (timerStat_mask << 8) | (shifterErr_mask << 4) | shifterStat_mask;

    
    while((i < 5) && (flexio_CallBackDesc[i].pCallBack))
    {
    ...
    ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMSTAT) = timerStat_mask;
    ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTSTAT) = shifterStat_mask;
    ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTERR) = shifterErr_mask;
  }
}
