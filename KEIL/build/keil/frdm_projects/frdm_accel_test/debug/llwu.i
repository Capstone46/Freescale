...
#line 16 "..\\..\\..\\..\\src\\drivers\\llwu\\llwu.c"
...
#line 17 "..\\..\\..\\..\\src\\drivers\\llwu\\llwu.c"



 
static LLWU_CALLBACK volatile pCallbackLLWU=0;
...
void LLWU_Init(tLLWU llwu,uint8 ip,LLWU_CALLBACK pCallback)
{
  ...
  if (pCallback != 0) { pCallbackLLWU = pCallback; }
  { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_LLWU)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_LLWU)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LLWU)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_LLWU)-16)%4)<<3)+6)); };
   
  ((((LLWU_MemMapPtr)0x4007C000u))->PE1) = llwu.PE1;
  ((((LLWU_MemMapPtr)0x4007C000u))->PE2) = llwu.PE2;
  ((((LLWU_MemMapPtr)0x4007C000u))->PE3) = llwu.PE3;
  ((((LLWU_MemMapPtr)0x4007C000u))->PE4) = llwu.PE4;
  ((((LLWU_MemMapPtr)0x4007C000u))->FILT1) = llwu.FILT1;
  ((((LLWU_MemMapPtr)0x4007C000u))->FILT2) = llwu.FILT2;
  ((((LLWU_MemMapPtr)0x4007C000u))->ME)  = llwu.ME;  
   
  { ((((LLWU_MemMapPtr)0x4007C000u))->F3) = (uint8)(((uint32)(0x0FFFFFFF)>>16)&0xff); ((((LLWU_MemMapPtr)0x4007C000u))->F2) = (uint8)(((uint32)(0x0FFFFFFF)>> 8)&0xff); ((((LLWU_MemMapPtr)0x4007C000u))->F1) = (uint8)(((uint32)(0x0FFFFFFF)>> 0)&0xff); }; 
}
...
void llwu_isr (void) 
{ 
  register uint32 tmp = ((uint32)((((LLWU_MemMapPtr)0x4007C000u))->F3)<<16)|((uint32)((((LLWU_MemMapPtr)0x4007C000u))->F2)<<8)|(uint32)((((LLWU_MemMapPtr)0x4007C000u))->F1);
   
  { ((((LLWU_MemMapPtr)0x4007C000u))->F3) = (uint8)(((uint32)(0x0FFFFFFF)>>16)&0xff); ((((LLWU_MemMapPtr)0x4007C000u))->F2) = (uint8)(((uint32)(0x0FFFFFFF)>> 8)&0xff); ((((LLWU_MemMapPtr)0x4007C000u))->F1) = (uint8)(((uint32)(0x0FFFFFFF)>> 0)&0xff); };
  if (pCallbackLLWU != (LLWU_CALLBACK)0) { pCallbackLLWU (tmp); }
}
