...
#line 11 "..\\..\\..\\..\\src\\drivers\\slcd\\lcd.c"
...
#line 12 "..\\..\\..\\..\\src\\drivers\\slcd\\lcd.c"



 
static LCD_CALLBACK volatile pCallbackLCD=0;
...
{
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 24),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 20),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 27),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 26),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 42),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 40),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 44),  
  (unsigned char *)& *((unsigned char *)&((((LCD_MemMapPtr)0x40053000u))->WF[0]) + 43),
};
                                          
static const unsigned char baAscii1 [] =
{
#line 96 "..\\..\\..\\..\\src\\drivers\\slcd\\lcd.c"
    ( 0x08+ 0x04+ 0x02),     ( 0x08+!0x04+ 0x02+ 0x01),   
    (!0x08+ 0x04+ 0x02),     (!0x08+!0x04+!0x02+!0x01),   
    ( 0x08+ 0x04+!0x02),     (!0x08+ 0x04+ 0x02+ 0x01),   
    ( 0x08+ 0x04+ 0x02),     (!0x08+ 0x04+!0x02+ 0x01),   
    (!0x08+ 0x04+ 0x02),     ( 0x08+ 0x04+!0x02+!0x01),   
    ...
    (!0x08+ 0x04+ 0x02),     ( 0x08+ 0x04+!0x02+ 0x01),   
    ( 0x08+ 0x04+!0x02),     (!0x08+ 0x04+ 0x02+!0x01),   
#line 229 "..\\..\\..\\..\\src\\drivers\\slcd\\lcd.c"
};

void LCD_InstallCallbackLCD (uint8 ip, LCD_CALLBACK pCallback)
{
  if (pCallback != 0) { pCallbackLCD = pCallback; }
  { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_LCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_LCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LCD)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_LCD)-16)%4)<<3)+6)); };
}

void LCD_Init (tLCD lcd, tLCD_FP lcd_fp, tLCD_BP lcd_bp, tLCD_CP lcd_cp)
{
   
  ((((LCD_MemMapPtr)0x40053000u))->PEN[0])     = lcd_fp.PENL;
  ((((LCD_MemMapPtr)0x40053000u))->PEN[1])     = lcd_fp.PENH;
   
  ((((LCD_MemMapPtr)0x40053000u))->BPEN[0])    = lcd_bp.BPENL;
  ((((LCD_MemMapPtr)0x40053000u))->BPEN[1])    = lcd_bp.BPENH;
   
  ((((LCD_MemMapPtr)0x40053000u))->WF[0])   = lcd_cp.WF0TO0;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[1])   = lcd_cp.WF7TO4;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[2])  = lcd_cp.WF11TO8;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[3]) = lcd_cp.WF15TO12;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[4]) = lcd_cp.WF19TO16;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[5]) = lcd_cp.WF23TO20;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[6]) = lcd_cp.WF27TO24;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[7]) = lcd_cp.WF31TO28;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[8]) = lcd_cp.WF35TO32;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[9]) = lcd_cp.WF39TO36;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[10]) = lcd_cp.WF43TO40;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[11]) = lcd_cp.WF47TO44;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[12]) = lcd_cp.WF51TO48;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[13]) = lcd_cp.WF55TO52;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[14]) = lcd_cp.WF59TO56;        
  ((((LCD_MemMapPtr)0x40053000u))->WF[15]) = lcd_cp.WF63TO60;        
   
  ((((LCD_MemMapPtr)0x40053000u))->AR)       = lcd.AR;
  ((((LCD_MemMapPtr)0x40053000u))->FDCR)     = lcd.FDCR;
  ((((LCD_MemMapPtr)0x40053000u))->GCR)     |= lcd.GCR;
   
  ((((LCD_MemMapPtr)0x40053000u))->GCR)     |= 0x80u;
}
...
void LCD_Write_Char (uint8 c)
{
    ...
    while (lbCounter--  && LCD_CharPosition < (4)  )
    {
        lbIndex = (unsigned char)(lbCounter + LCD_CharPosition * (2));                    
...
void LCD_isr (void) 
{
  ...
  if (pCallbackLCD != (LCD_CALLBACK)0) 
  {
      
      tmp = (((((LCD_MemMapPtr)0x40053000u))->AR) & (0x80u|0x40u|0x20u|                           0x8u|0x7u) );

    
      tmp = (((((LCD_MemMapPtr)0x40053000u))->FDSR) & 0xFFu );
    
       
      if (tmp == 0x8000u)
      {
        pCallbackLCD (LCD_FDCF_CALLBACK);
        ((((LCD_MemMapPtr)0x40053000u))->FDSR) |= 0x8000u;                            
      }
