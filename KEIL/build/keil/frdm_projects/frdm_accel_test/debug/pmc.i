...
#line 17 "..\\..\\..\\..\\src\\drivers\\pmc\\pmc.c"



 
static PMC_CALLBACK volatile pCallbackPMC=0;
...
{
  if (pCallback != 0) { pCallbackPMC = pCallback; }
  { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_PMC)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_PMC)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PMC)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_PMC)-16)%4)<<3)+6)); };
  ((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) = (pmc.LVDSC1 | 0x40u);
  ((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) = (pmc.LVDSC2 | 0x40u);
  ((((PMC_MemMapPtr)0x4007D000u))->REGSC)  = pmc.REGSC;
}
...
void pmc_isr (void) 
{ 
  if (pCallbackPMC != (PMC_CALLBACK)0)
  {
    if ((((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) & 0x80u) && (((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) & 0x20u))
    {
      ((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) |= 0x40u;    
      pCallbackPMC (LVD_CALLBACK);
    }
    if ((((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) & 0x80u) && (((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) & 0x20u))
    {
      ((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) |= 0x40u;   
