...
#line 15 "..\\..\\..\\..\\src\\drivers\\tpm\\tpm.c"



 
static TPM_CALLBACK volatile pCallbackTPM0=0;
static TPM_CALLBACK volatile pCallbackTPM1=0;
static TPM_CALLBACK volatile pCallbackTPM2=0;
...
{
  if (pCallback != 0) { pCallbackTPM0 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_TPM0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_TPM0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_TPM0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_TPM0)-16)%4)<<3)+6)); };}
  ((((TPM_MemMapPtr)0x40038000u))->CONF) 	= tpm.CONF;
  ((((TPM_MemMapPtr)0x40038000u))->CNT)      = 0l; 
  ((((TPM_MemMapPtr)0x40038000u))->MOD)      = modVal;
  ((((TPM_MemMapPtr)0x40038000u))->SC)       = tpm.SC;
}

void TPM1_Init (tTPM tpm, uint16 modVal, uint8 ip, TPM_CALLBACK pCallback)
{
  if (pCallback != 0) { pCallbackTPM1 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_TPM1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_TPM1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_TPM1)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_TPM1)-16)%4)<<3)+6)); };}
  ((((TPM_MemMapPtr)0x40039000u))->CONF) 	= tpm.CONF;
  ((((TPM_MemMapPtr)0x40039000u))->CNT)      = 0l;
  ((((TPM_MemMapPtr)0x40039000u))->MOD)      = modVal;
  ((((TPM_MemMapPtr)0x40039000u))->SC)       = tpm.SC;
}

void TPM2_Init (tTPM tpm, uint16 modVal, uint8 ip, TPM_CALLBACK pCallback)
{
  if (pCallback != 0) { pCallbackTPM2 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_TPM2)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_TPM2)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_TPM2)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_TPM2)-16)%4)<<3)+6)); };}
  ((((TPM_MemMapPtr)0x4003A000u))->CONF) 	= tpm.CONF;
  ((((TPM_MemMapPtr)0x4003A000u))->CNT)      = 0l; 
  ((((TPM_MemMapPtr)0x4003A000u))->MOD)      = modVal;
  ((((TPM_MemMapPtr)0x4003A000u))->SC)       = tpm.SC;
}

 
void TPM0CH0_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[0]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[0]. CnV)  = value;
}

void TPM0CH1_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[1]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[1]. CnV)  = value;
}

void TPM0CH2_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[2]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[2]. CnV)  = value;
}

void TPM0CH3_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[3]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[3]. CnV)  = value;
}

void TPM0CH4_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnV)  = value;
}

void TPM0CH5_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnV)  = value;
}

void TPM1CH0_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnV)  = value;
}

void TPM1CH1_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[1]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[1]. CnV)  = value;
}

void TPM2CH0_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[0]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[0]. CnV)  = value;
}

void TPM2CH1_Init (tTPM_CH tpm_ch, uint16 value)
{
    ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[1]. CnSC) = tpm_ch.CnSC;
    ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[1]. CnV)  = value;
}
...
{      
  ...
  if (pCallbackTPM0 != (TPM_CALLBACK)0) 
  { 
    if ((((((TPM_MemMapPtr)0x40038000u))->SC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->SC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->SC) |= 0x80u; pCallbackTPM0 (TOF_CALLBACK_MASK); 
    }   
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[0]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[0]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[0]. CnSC) |= 0x80u; pCallbackTPM0 (CH0F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[1]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[1]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[1]. CnSC) |= 0x80u; pCallbackTPM0 (CH1F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[2]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[2]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[2]. CnSC) |= 0x80u; pCallbackTPM0 (CH2F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[3]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[3]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[3]. CnSC) |= 0x80u; pCallbackTPM0 (CH3F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnSC) |= 0x80u; pCallbackTPM0 (CH4F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnSC) |= 0x80u; pCallbackTPM0 (CH5F_CALLBACK_MASK);
    }
  }    
}
...
{      
  ...
  if (pCallbackTPM1 != (TPM_CALLBACK)0) 
  { 
    if ((((((TPM_MemMapPtr)0x40039000u))->SC) & 0x40u) && (((((TPM_MemMapPtr)0x40039000u))->SC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40039000u))->SC) |= 0x80u; pCallbackTPM1 (TOF_CALLBACK_MASK); 
    }   
    if ((((((TPM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnSC) |= 0x80u; pCallbackTPM1 (CH0F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x40039000u))->CONTROLS[1]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x40039000u))->CONTROLS[1]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x40039000u))->CONTROLS[1]. CnSC) |= 0x80u; pCallbackTPM1 (CH1F_CALLBACK_MASK);
    }
  }    
}
...
{      
  ...
  if (pCallbackTPM2 != (TPM_CALLBACK)0) 
  { 
    if ((((((TPM_MemMapPtr)0x4003A000u))->SC) & 0x40u) && (((((TPM_MemMapPtr)0x4003A000u))->SC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x4003A000u))->SC) |= 0x80u; pCallbackTPM2 (TOF_CALLBACK_MASK); 
    }   
    if ((((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[0]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[0]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[0]. CnSC) |= 0x80u; pCallbackTPM2 (CH0F_CALLBACK_MASK);
    }
    if ((((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[1]. CnSC) & 0x40u) && (((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[1]. CnSC) & 0x80u)) 
    { 
      ((((TPM_MemMapPtr)0x4003A000u))->CONTROLS[1]. CnSC) |= 0x80u; pCallbackTPM2 (CH1F_CALLBACK_MASK);
    }
  }    
}
