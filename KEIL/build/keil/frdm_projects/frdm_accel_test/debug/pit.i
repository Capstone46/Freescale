...
#line 17 "..\\..\\..\\..\\src\\drivers\\pit\\pit.c"



 
static PIT_CALLBACK pCallbackPIT=0;
...
void PIT0_CH0_Init  (tPIT_CH ch, uint32 value, uint8 ip, PIT_CALLBACK pCallback)
{
  ...
  { 
    ...
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_PIT)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_PIT)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PIT)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_PIT)-16)%4)<<3)+6)); }; 
  }
  else
  { 
    pCallbackPIT = 0; 
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_PIT)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PIT)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_PIT)-16)%4)<<3)+6))); }; 
  }
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. LDVAL)  = value;
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG)   = 0x1u;    
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TCTRL)  = ch.TCTRL;
  ((((PIT_MemMapPtr)0x40037000u))->MCR)    &= ~0x0002;                
}
...
void PIT0_CH1_Init  (tPIT_CH ch, uint32 value, uint8 ip, PIT_CALLBACK pCallback)
{
  ...
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. LDVAL)  = value;
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TFLG)   = 0x1u;    
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TCTRL)  = ch.TCTRL;
  ((((PIT_MemMapPtr)0x40037000u))->MCR)    &= ~0x0002;              
}
...
{ 
  ...
  if (((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG) == 0x1u)
  {
    ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG) = 0x1u;    
    if (pCallbackPIT != (PIT_CALLBACK)0) 
      pCallbackPIT (PIT0CH0_CALLBACK);
  }

   
  if (((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TFLG) == 0x1u)
  {
    ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TFLG) = 0x1u;    
    if (pCallbackPIT != (PIT_CALLBACK)0) 
