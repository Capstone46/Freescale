...
#line 18 "..\\..\\..\\..\\src\\cpu\\arm_cm0.c"
#line 19 "..\\..\\..\\..\\src\\cpu\\arm_cm0.c"
...
static SYSTICK_CALLBACK pCallbackSYSTICK=0;
...
{
  volatile unsigned int dummy = ((((SysTick_MemMapPtr)0xE000E010u))->CSR);
  
  if (pCallback != 0)  
  { 
    pCallbackSYSTICK = pCallback;
  }
  ((((SysTick_MemMapPtr)0xE000E010u))->RVR) = cfg.RVR;
  ((((SysTick_MemMapPtr)0xE000E010u))->CSR) = cfg.CSR;
}
