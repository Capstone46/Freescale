...
#line 17 "..\\..\\..\\..\\src\\common\\startup.c"

#line 27 "..\\..\\..\\..\\src\\common\\startup.c"
...
#line 57 "..\\..\\..\\..\\src\\common\\startup.c"
	...
	data_temp0 = ((uint32)&Image$$ER_ROM$$Limit+ (uint32)&Image$$ER_RAM_CODE$$Length+3)&(~0x3);

  uint8* data_rom = (uint8*)data_temp0;
	data_temp1 = data_temp0+((uint32)&Image$$ER_RAM_DATA$$Length+3)&(~0x3);
	uint8* data_rom_end = (uint8*)data_temp1;
	 
	uint32 bss_temp0;
	uint8* bss_start;
	bss_start = (uint8*)&Image$$ER_RAM_BSS$$ZI$$Base;
	bss_temp0 = ((uint32)&Image$$ER_RAM_BSS$$ZI$$Base + (uint32)&Image$$ER_RAM_BSS$$ZI$$Length+3)&(~0x3);
	...
	code_relocate_temp0 = ((uint32)&Image$$ER_ROM$$Limit+3)&(~0x3);
 	uint8* code_relocate = (uint8*)code_relocate_temp0;
	code_relocate_temp1 = ((uint32)&Image$$ER_ROM$$Limit+ (uint32)&Image$$ER_RAM_CODE$$Length+3)&(~0x3);
