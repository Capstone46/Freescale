#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
#line 34 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
#line 35 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
#line 36 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.h"
...
#line 27 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.h"
...
#line 37 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
#line 41 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
#line 43 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
#line 44 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\usb_mouse.c"
...
static boolean mouse_init = 0;           



__align(4) 

static uint_8 rpt_buf[(4)];     
...
static uint_8 g_app_request_params[2];      
...
{
  uint_8 status = (0x00);
  uint_8 index = (uint_8)((request - 2) & (0x01));
  ...
  *size = 0;
  ...
  switch(request)
  {
    ...
    case (0x0A) :
      ...
      g_app_request_params[index] =(uint_8)((value & (0xFF00)) >>
                                            (8));
      break;
...
void USB_Mouse_Init(void)
{
  ...
  *((uint_32_ptr)null_buf) = 0;
  ...
  ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) = (1 << 24);       
  ((((NVIC_MemMapPtr)0xE000E100u))->ISER) = (1 << 24);       

  ((((USB_MemMapPtr)0x40072000u))->CLK_RECOVER_IRC_EN) = 0x2u|0x1u;
  ((((USB_MemMapPtr)0x40072000u))->CLK_RECOVER_CTRL) = 0x80u|0x20u;
  
   
  error = USB_Class_HID_Init((0), 
                             USB_Mouse_Callback, 
                             0, 
...
void USB_Mouse_Update(uint_8 left_bt, uint_8 rigth_bt, int_8  x, int_8  y)
{
  ...
  {   
    ...
    {
      (void)USB_Class_HID_Send_Data((0), 
                                    (1), 
                                    rpt_buf,
                                    (4));
