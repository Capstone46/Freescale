...
{
  ((((SIM_MemMapPtr)0x40047000u))->SOPT1CFG)= sim.SOPT1CFG;
  if (!(sim.SOPT1&0x80000000u))
    ((((SIM_MemMapPtr)0x40047000u))->SOPT1CFG) |= 0x1000000u;
  ((((SIM_MemMapPtr)0x40047000u))->SOPT1)   = sim.SOPT1;
  ((((SIM_MemMapPtr)0x40047000u))->SOPT2)   = sim.SOPT2;
  ((((SIM_MemMapPtr)0x40047000u))->SOPT4)   = sim.SOPT4;
  ((((SIM_MemMapPtr)0x40047000u))->SOPT5)   = sim.SOPT5;
  ((((SIM_MemMapPtr)0x40047000u))->SOPT7)   = sim.SOPT7;
  ((((SIM_MemMapPtr)0x40047000u))->SCGC4)   = sim.SCGC4;
  ((((SIM_MemMapPtr)0x40047000u))->SCGC5)   = sim.SCGC5;
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6)   = sim.SCGC6;
  ((((SIM_MemMapPtr)0x40047000u))->SCGC7)   = sim.SCGC7;
  ((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) = sim.CLKDIV1;
}
