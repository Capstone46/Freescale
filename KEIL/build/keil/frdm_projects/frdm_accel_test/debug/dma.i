...
#line 17 "..\\..\\..\\..\\src\\drivers\\dma\\dma.c"



 
static DMA_CALLBACK volatile pCallbackDMA0=0;
static DMA_CALLBACK volatile pCallbackDMA1=0;
static DMA_CALLBACK volatile pCallbackDMA2=0;
static DMA_CALLBACK volatile pCallbackDMA3=0;
...
{
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[0]) = dmamux.MUX_CHCFG;
}

void DMAMUX0_CH1_Init(tDMAMUX dmamux)
{
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[1]) = dmamux.MUX_CHCFG;
} 

void DMAMUX0_CH2_Init(tDMAMUX dmamux)
{
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[2]) = dmamux.MUX_CHCFG;
} 

void DMAMUX0_CH3_Init(tDMAMUX dmamux)
{
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[3]) = dmamux.MUX_CHCFG;
}
...
void DMA0_Init(tDMA dma, uint32* sard, uint32* dadr, uint8 ip, DMA_CALLBACK pCallback)
{
  ...
  u32Temp = ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[0]);
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[0]) = 0x0;
  if (pCallback != 0) { pCallbackDMA0 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_DMA0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_DMA0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_DMA0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_DMA0)-16)%4)<<3)+6)); };}
  ((((DMA_MemMapPtr)0x40008000u))->DMA[0]. SAR) = (uint32)sard;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[0]. DAR) = (uint32)dadr;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[0]. DCR) = dma.DCR;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[0]. DSR_BCR) = dma.BCR;
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[0]) = u32Temp;
}
...
void DMA1_Init(tDMA dma, uint32* sard, uint32* dadr, uint8 ip, DMA_CALLBACK pCallback)
{
  ...
  u32Temp = ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[1]);
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[1]) = 0x0;
  if (pCallback != 0) { pCallbackDMA1 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_DMA1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_DMA1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_DMA1)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_DMA1)-16)%4)<<3)+6)); };}
  ((((DMA_MemMapPtr)0x40008000u))->DMA[1]. SAR) = (uint32)sard;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[1]. DAR) = (uint32)dadr;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[1]. DCR) = dma.DCR;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[1]. DSR_BCR) = dma.BCR;
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[1]) = u32Temp;
}
...
void DMA2_Init(tDMA dma, uint32* sard, uint32* dadr, uint8 ip, DMA_CALLBACK pCallback)
{
  ...
  u32Temp = ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[2]);
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[2]) = 0x0;
  if (pCallback != 0) { pCallbackDMA2 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_DMA2)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_DMA2)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_DMA2)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_DMA2)-16)%4)<<3)+6)); };}
  ((((DMA_MemMapPtr)0x40008000u))->DMA[2]. SAR) = (uint32)sard;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[2]. DAR) = (uint32)dadr;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[2]. DCR) = dma.DCR;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[2]. DSR_BCR) = dma.BCR;
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[2]) = u32Temp;
}
...
void DMA3_Init(tDMA dma, uint32* sard, uint32* dadr, uint8 ip, DMA_CALLBACK pCallback)
{
  ...
  u32Temp = ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[3]);
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[3]) = 0x0;
  if (pCallback != 0) { pCallbackDMA3 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_DMA3)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_DMA3)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_DMA3)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_DMA3)-16)%4)<<3)+6)); };}
  ((((DMA_MemMapPtr)0x40008000u))->DMA[3]. SAR) = (uint32)sard;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[3]. DAR) = (uint32)dadr;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[3]. DCR) = dma.DCR;
  ((((DMA_MemMapPtr)0x40008000u))->DMA[3]. DSR_BCR) = dma.BCR;
  ((((DMAMUX_MemMapPtr)0x40021000u))->CHCFG[3]) = u32Temp;
}
...
void dma0_isr (void) 
{ 
  if (pCallbackDMA0 != (DMA_CALLBACK)0) 
  { 
    if (((((DMA_MemMapPtr)0x40008000u))->DMA[0]. DSR_BCR) & 0x1000000u) 
    { 
      ((((DMA_MemMapPtr)0x40008000u))->DMA[0]. DSR_BCR) |= 0x1000000u;
...
void dma1_isr (void) 
{ 
  if (pCallbackDMA1 != (DMA_CALLBACK)0) 
  { 
    if (((((DMA_MemMapPtr)0x40008000u))->DMA[1]. DSR_BCR) & 0x1000000u) 
    { 
      ((((DMA_MemMapPtr)0x40008000u))->DMA[1]. DSR_BCR) |= 0x1000000u;
...
void dma2_isr (void) 
{ 
  if (pCallbackDMA2 != (DMA_CALLBACK)0) 
  { 
    if (((((DMA_MemMapPtr)0x40008000u))->DMA[2]. DSR_BCR) & 0x1000000u) 
    { 
      ((((DMA_MemMapPtr)0x40008000u))->DMA[2]. DSR_BCR) |= 0x1000000u;
...
void dma3_isr (void) 
{ 
  if (pCallbackDMA3 != (DMA_CALLBACK)0) 
  { 
    if (((((DMA_MemMapPtr)0x40008000u))->DMA[3]. DSR_BCR) & 0x1000000u) 
    { 
      ((((DMA_MemMapPtr)0x40008000u))->DMA[3]. DSR_BCR) |= 0x1000000u;
