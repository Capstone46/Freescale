...
static I2C_CALLBACK volatile pCallbackI2C0=0;
static I2C_CALLBACK volatile pCallbackI2C1=0;
...
void I2C0_Init (tI2C i2c, uint8 ip, I2C_CALLBACK pCallback)
{
  if (pCallback != 0)
  {
    ...
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_I2C0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_I2C0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_I2C0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_I2C0)-16)%4)<<3)+6)); };
  }
  ((((I2C_MemMapPtr)0x40066000u))->A1)    = i2c.A1;
  ((((I2C_MemMapPtr)0x40066000u))->F)     = i2c.F;
  ((((I2C_MemMapPtr)0x40066000u))->C1)    = i2c.C1;
  ((((I2C_MemMapPtr)0x40066000u))->FLT)   = i2c.FLT;
  ((((I2C_MemMapPtr)0x40066000u))->RA)    = i2c.RA;
  ((((I2C_MemMapPtr)0x40066000u))->SMB)   = i2c.SMB;
  ((((I2C_MemMapPtr)0x40066000u))->A2)    = i2c.A2;
  ((((I2C_MemMapPtr)0x40066000u))->SLTH)  = i2c.SLTH;
  ((((I2C_MemMapPtr)0x40066000u))->SLTL)  = i2c.SLTL;
}
...
void I2C1_Init (tI2C i2c, uint8 ip, I2C_CALLBACK pCallback)
{
  if (pCallback != 0)
  {
    ...
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_I2C1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_I2C1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_I2C1)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_I2C1)-16)%4)<<3)+6)); };
  }
  ((((I2C_MemMapPtr)0x40067000u))->A1)    = i2c.A1;
  ((((I2C_MemMapPtr)0x40067000u))->F)     = i2c.F;
  ((((I2C_MemMapPtr)0x40067000u))->C1)    = i2c.C1;
  ((((I2C_MemMapPtr)0x40067000u))->FLT)   = i2c.FLT;
  ((((I2C_MemMapPtr)0x40067000u))->RA)    = i2c.RA;
  ((((I2C_MemMapPtr)0x40067000u))->SMB)   = i2c.SMB;
  ((((I2C_MemMapPtr)0x40067000u))->A2)    = i2c.A2;
  ((((I2C_MemMapPtr)0x40067000u))->SLTH)  = i2c.SLTH;
  ((((I2C_MemMapPtr)0x40067000u))->SLTL)  = i2c.SLTL;
}
...
void I2C0_WriteByte(uint8 u8DevAdr, uint8 u8RegAdr, uint8 u8Data)
{
  ...
  { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x10u)|(0x1<<4)); };
  { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x20u)|(0x1<<5)); };

  I2C0_CycleWrite((uint8)((u8DevAdr<<1)&0xFE));
  I2C0_CycleWrite(u8RegAdr);
  I2C0_CycleWrite(u8Data);

  { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x20u)|(0x0<<5)); };
  while((((((I2C_MemMapPtr)0x40066000u))->S)&0x20u) &&
        (timeout<1000))
    timeout++;
}
...
void I2C1_WriteByte(uint8 u8DevAdr, uint8 u8RegAdr, uint8 u8Data)
{
  ...
  { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x10u)|(0x1<<4)); };
  { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x20u)|(0x1<<5)); };

  I2C1_CycleWrite((uint8)((u8DevAdr<<1)&0xFE));
  I2C1_CycleWrite(u8RegAdr);
  I2C1_CycleWrite(u8Data);

  { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x20u)|(0x0<<5)); };
  while((((((I2C_MemMapPtr)0x40067000u))->S)&0x20u) &&
        (timeout<1000))
    timeout++;
}
...
uint8 I2C0_ReadByte(uint8 u8DevAdr, uint8 u8RegAdr)
{
  ...
  { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x4u)|(0x1<<2)); };

  I2C0_CycleWrite((uint8)((u8DevAdr<<1)|0x01));

  dummy = I2C0_CycleRead(1);
  dummy = I2C0_CycleRead(1);
...
uint8 I2C1_ReadByte(uint8 u8DevAdr, uint8 u8RegAdr)
{
  ...
  { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x4u)|(0x1<<2)); };

  I2C1_CycleWrite((uint8)((u8DevAdr<<1)|0x01));

  dummy = I2C1_CycleRead(1);
  dummy = I2C1_CycleRead(1);
...
void I2C0_ReadMultiBytes(uint8 u8DevAdr, uint8 u8RegAdr, uint8 *array, uint8 length)
{
  ...
  dummy = I2C0_CycleRead(0);
  for (i = 0; i < length; i++)
  {
    *(array++) = I2C0_CycleRead(0);
  }
  *(array++) = I2C0_CycleRead(1);
...
void I2C1_ReadMultiBytes(uint8 u8DevAdr, uint8 u8RegAdr, uint8 *array, uint8 length)
{
  ...
  dummy = I2C1_CycleRead(0);
  for (i = 0; i < length; i++)
  {
    *(array++) = I2C1_CycleRead(0);
  }
  *(array++) = I2C1_CycleRead(1);
...
void I2C0_CycleWrite(uint8 u8Data)
{
  ...
  while (((!(((((I2C_MemMapPtr)0x40066000u))->S)&0x80u)) || (!(((((I2C_MemMapPtr)0x40066000u))->S2)&0x1u))) &&
         (timeout<1000))
  ...
  timeout++;
  (((((I2C_MemMapPtr)0x40066000u))->D) = u8Data);
  timeout = 0;
  while((!(((((I2C_MemMapPtr)0x40066000u))->S)&0x2u)) &&
        (timeout<1000))
  timeout++;
  { ((((I2C_MemMapPtr)0x40066000u))->S)=((((((I2C_MemMapPtr)0x40066000u))->S)&~0x2u)|(0x1<<1)); };
}
...
void I2C1_CycleWrite(uint8 u8Data)
{
  ...
  while (((!(((((I2C_MemMapPtr)0x40067000u))->S)&0x80u)) || (!(((((I2C_MemMapPtr)0x40067000u))->S2)&0x1u))) &&
         (timeout<1000))
  ...
  timeout++;
  (((((I2C_MemMapPtr)0x40067000u))->D) = u8Data);
  timeout = 0;
  while((!(((((I2C_MemMapPtr)0x40067000u))->S)&0x2u)) &&
        (timeout<1000))
  timeout++;
  ((((I2C_MemMapPtr)0x40067000u))->S) |= 0x02;;
}
...
uint8 I2C0_CycleRead(uint8 u8Ack)
{
  ...
  timeout = 0;
  while ((!(((((I2C_MemMapPtr)0x40066000u))->S)&0x80u)) &&
         (timeout<1000))
  timeout++;
  { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x10u)|(0x0<<4)); };
  if (u8Ack)
  {
    { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x8u)|(0x1<<3)); };
  }
  else
  {
    { ((((I2C_MemMapPtr)0x40066000u))->C1)=((((((I2C_MemMapPtr)0x40066000u))->C1)&~0x8u)|(0x0<<3)); };
  }
  dummy = (uint8)((((I2C_MemMapPtr)0x40066000u))->D);
  timeout = 0;
  while((!(((((I2C_MemMapPtr)0x40066000u))->S)&0x2u)) &&
        (timeout<1000))
  timeout++;
...
uint8 I2C1_CycleRead(uint8 u8Ack)
{
  ...
  timeout = 0;
  while ((!(((((I2C_MemMapPtr)0x40067000u))->S)&0x80u)) &&
         (timeout<1000))
  timeout++;
  { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x10u)|(0x0<<4)); };
  if (u8Ack)
  {
    { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x8u)|(0x1<<3)); };
  }
  else
  {
    { ((((I2C_MemMapPtr)0x40067000u))->C1)=((((((I2C_MemMapPtr)0x40067000u))->C1)&~0x8u)|(0x0<<3)); };
  }
  dummy = (uint8)((((I2C_MemMapPtr)0x40067000u))->D);
  timeout = 0;
  while((!(((((I2C_MemMapPtr)0x40067000u))->S)&0x2u)) &&
        (timeout<1000))
  timeout++;
...
void I2C0_isr (void)
{
  ...
  if ((((((I2C_MemMapPtr)0x40066000u))->FLT)&0x40u))
    { ((((I2C_MemMapPtr)0x40066000u))->FLT)=((((((I2C_MemMapPtr)0x40066000u))->FLT)&~0x40u)|(0x1<<6)); };
  if ((((((I2C_MemMapPtr)0x40066000u))->S)&0x2u))
  {
      { ((((I2C_MemMapPtr)0x40066000u))->S)=((((((I2C_MemMapPtr)0x40066000u))->S)&~0x2u)|(0x1<<1)); };
...
void I2C1_isr (void)
{
  ((((GPIO_MemMapPtr)0x400FF0C0u))->PSOR)=((uint32)(1 << 6));;
   
  if ((((((I2C_MemMapPtr)0x40067000u))->FLT)&0x40u))
    { ((((I2C_MemMapPtr)0x40067000u))->FLT)=((((((I2C_MemMapPtr)0x40067000u))->FLT)&~0x40u)|(0x1<<6)); };
  if ((((((I2C_MemMapPtr)0x40067000u))->S)&0x2u))
  {
      ((((I2C_MemMapPtr)0x40067000u))->S) |= 0x02;;
      pCallbackI2C1 (I2C1_CALLBACK);
  }
  ((((GPIO_MemMapPtr)0x400FF0C0u))->PCOR)=((uint32)(1 << 6));;
}
