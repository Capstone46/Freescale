#line 1 "..\\..\\..\\..\\src\\drivers\\vref\\vref.c"
...
#line 14 "..\\..\\..\\..\\src\\drivers\\vref\\vref.c"
...
#line 15 "..\\..\\..\\..\\src\\drivers\\vref\\vref.c"
...
{     
  ((((VREF_MemMapPtr)0x40074000u))->SC)    = 0x80u;               
   
  if (vref.SC & 0x80u)  
    while (!(((((VREF_MemMapPtr)0x40074000u))->SC) & 0x4u));
  ((((VREF_MemMapPtr)0x40074000u))->SC)    = vref.SC;                   
}
