...
#line 16 "..\\..\\..\\..\\src\\drivers\\cmp\\cmp.c"



 
static CMP_CALLBACK volatile pCallbackCMP0=0;
...
void CMP0_Init (tCMP cmp, uint8 psel, uint8 nsel, uint8 ip, CMP_CALLBACK pCallback)
{
  ...
  { 
    ...
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_CMP0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_CMP0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_CMP0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_CMP0)-16)%4)<<3)+6)); };
  } 
  ((((CMP_MemMapPtr)0x40073000u))->CR0)   = cmp.CR0;
  ((((CMP_MemMapPtr)0x40073000u))->CR1)   = cmp.CR1;
  ((((CMP_MemMapPtr)0x40073000u))->FPR)   = cmp.FPR;
  ((((CMP_MemMapPtr)0x40073000u))->SCR)   = cmp.SCR;
  ((((CMP_MemMapPtr)0x40073000u))->DACCR) = cmp.DACCR;
  ((((CMP_MemMapPtr)0x40073000u))->MUXCR) = (uint8)((psel<<3)|nsel);
}
...
void cmp0_isr (void) 
{
  if (pCallbackCMP0 != (CMP_CALLBACK)0) 
  {
       
    if ((((((CMP_MemMapPtr)0x40073000u))->SCR) & 0x10u) && (((((CMP_MemMapPtr)0x40073000u))->SCR) & 0x4u))
    {
      ((((CMP_MemMapPtr)0x40073000u))->SCR) = (((((CMP_MemMapPtr)0x40073000u))->SCR)&(~0x4u))|0x4u;
      pCallbackCMP0 (CMP_RE_CALLBACK);
    }
       
    if ((((((CMP_MemMapPtr)0x40073000u))->SCR) & 0x8u) && (((((CMP_MemMapPtr)0x40073000u))->SCR) & 0x2u))
    {
      ((((CMP_MemMapPtr)0x40073000u))->SCR) = (((((CMP_MemMapPtr)0x40073000u))->SCR)&(~0x2u))|0x2u;
