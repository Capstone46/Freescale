#line 1 "..\\..\\..\\..\\src\\drivers\\gpio\\gpio.c"
...
#line 14 "..\\..\\..\\..\\src\\drivers\\gpio\\gpio.c"
...
#line 15 "..\\..\\..\\..\\src\\drivers\\gpio\\gpio.c"



 
static PORT_CALLBACK volatile pCallbackPORTA=0;
static PORT_CALLBACK volatile pCallbackPORTC=0;
static PORT_CALLBACK volatile pCallbackPORTD=0;
...
void PORTA_Init (tPORT port, uint32 pin_mask, uint8 ip, PORT_CALLBACK pCallback)
{
  ...
  if (pCallback != 0) { pCallbackPORTA = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_PORTA)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_PORTA)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PORTA)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_PORTA)-16)%4)<<3)+6)); };}
  
  for (i=0; i<32; i++)
    if(pin_mask & (uint32)(1l << i)) { ((PORT_MemMapPtr)0x40049000u)->PCR[i] = port.PCR; }  
  ((((PORT_MemMapPtr)0x40049000u))->ISFR) &= ~pin_mask;  
}
...
void PORTB_Init (tPORT port, uint32 pin_mask, uint8 ip, PORT_CALLBACK pCallback)
{
  ...
  for (i=0; i<32; i++)
    if(pin_mask & (uint32)(1l << i)) { ((PORT_MemMapPtr)0x4004A000u)->PCR[i] = port.PCR; }
  ((((PORT_MemMapPtr)0x4004A000u))->ISFR) &= ~pin_mask;  
}
...
void PORTC_Init (tPORT port, uint32 pin_mask, uint8 ip, PORT_CALLBACK pCallback)
{
  ...
  if (pCallback != 0) { pCallbackPORTC = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_PORTCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_PORTCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PORTCD)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_PORTCD)-16)%4)<<3)+6)); };}
  
  for (i=0; i<32; i++)
    if(pin_mask & (uint32)(1l << i)) { ((PORT_MemMapPtr)0x4004B000u)->PCR[i] = port.PCR; }
  ((((PORT_MemMapPtr)0x4004B000u))->ISFR) &= ~pin_mask;
}
...
void PORTD_Init (tPORT port, uint32 pin_mask, uint8 ip, PORT_CALLBACK pCallback)
{
  ...
  if (pCallback != 0) { pCallbackPORTD = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_PORTCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_PORTCD)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_PORTCD)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_PORTCD)-16)%4)<<3)+6)); };}
    
  for (i=0; i<32; i++)
    if(pin_mask & (uint32)(1l << i)) { ((PORT_MemMapPtr)0x4004C000u)->PCR[i] = port.PCR; } 
  ((((PORT_MemMapPtr)0x4004C000u))->ISFR) &= ~pin_mask;  
}
...
void PORTE_Init (tPORT port, uint32 pin_mask, uint8 ip, PORT_CALLBACK pCallback)
{
  ...
  for (i=0; i<32; i++)
    if(pin_mask & (uint32)(1l << i)) { ((PORT_MemMapPtr)0x4004D000u)->PCR[i] = port.PCR; } 
  ((((PORT_MemMapPtr)0x4004D000u))->ISFR) &= ~pin_mask;  
}

void GPIOA_Init (tGPIO gpio, uint32 pin_mask)
{
  ((((GPIO_MemMapPtr)0x400FF000u))->PDDR) = (((((GPIO_MemMapPtr)0x400FF000u))->PDDR) & ~pin_mask) | (gpio.PDDR & pin_mask); 
}

void GPIOB_Init (tGPIO gpio, uint32 pin_mask)
{
  ((((GPIO_MemMapPtr)0x400FF040u))->PDDR) = (((((GPIO_MemMapPtr)0x400FF040u))->PDDR) & ~pin_mask) | (gpio.PDDR & pin_mask);
}

void GPIOC_Init (tGPIO gpio, uint32 pin_mask)
{
  ((((GPIO_MemMapPtr)0x400FF080u))->PDDR) = (((((GPIO_MemMapPtr)0x400FF080u))->PDDR) & ~pin_mask) | (gpio.PDDR & pin_mask);
}

void GPIOD_Init (tGPIO gpio, uint32 pin_mask)
{
  ((((GPIO_MemMapPtr)0x400FF0C0u))->PDDR) = (((((GPIO_MemMapPtr)0x400FF0C0u))->PDDR) & ~pin_mask) | (gpio.PDDR & pin_mask);
}

void GPIOE_Init (tGPIO gpio, uint32 pin_mask)
{
  ((((GPIO_MemMapPtr)0x400FF100u))->PDDR) = (((((GPIO_MemMapPtr)0x400FF100u))->PDDR) & ~pin_mask) | (gpio.PDDR & pin_mask);
}
...
void porta_isr (void) 
{ 
  register uint32 temp32 = ((((PORT_MemMapPtr)0x40049000u))->ISFR);
  ((((PORT_MemMapPtr)0x40049000u))->ISFR) = temp32;              
     
  if (pCallbackPORTA != (PORT_CALLBACK)0) { pCallbackPORTA (temp32); }
}

void portcd_isr (void) 
{ 
  register uint32 u32TempC = ((((PORT_MemMapPtr)0x4004B000u))->ISFR), u32TempD = ((((PORT_MemMapPtr)0x4004C000u))->ISFR);
  ((((PORT_MemMapPtr)0x4004B000u))->ISFR) = u32TempC;              
  ((((PORT_MemMapPtr)0x4004C000u))->ISFR) = u32TempD;              
     
  if (pCallbackPORTC != (PORT_CALLBACK)0)  
  { 
    pCallbackPORTC (u32TempC); 
  }
  if (pCallbackPORTD != (PORT_CALLBACK)0)  
  { 
