#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
#line 39 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dciapi.h"
...
#line 42 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dciapi.h"
...
#line 43 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dciapi.h"
...
#line 148 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dciapi.h"
...
#line 40 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
#line 41 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
...
#line 41 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
#line 42 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
#line 43 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
...
#line 65 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
...
#line 102 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"

 
#line 110 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
...
#line 156 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"
...
typedef union {
  ...
  struct {
    ...
    uint_8 EP_TX_EN    :1;                                        
    uint_8 EP_RX_EN    :1;                                        
    uint_8 EP_CTRL_DIS  :1;                                        
    uint_8             :1;
    uint_8 RETRY_DIS   :1;                                        
    uint_8 HOST_WO_HUB :1;                                        
  } Bits;
} ENDPT0STR;
...
#line 308 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.h"

#line 42 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_bdt_kinetis.h"
...
#line 42 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_bdt_kinetis.h"
...
#line 58 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_bdt_kinetis.h"
...
#line 132 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_bdt_kinetis.h"
#pragma pack(pop)
...
#line 43 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
#line 45 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
	  ...
	  __align(512) uint_8 g_Mem[(1024)]; 
#line 74 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
	 
	BDTMAP *g_bdtmap = 0;
	 
	static BDT_ELEM  g_bdt_elem[(64) >> 1];
...
static uint_8 g_trf_direction = (0xFF);



#line 127 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
#line 187 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
static void USB_Bus_Reset_Handler (void)
{
    ...
    ((((USB_MemMapPtr)0x40072000u))->CTL1) |= 0x2u;                 
    ...
    Clear_Mem((uint_8_ptr)(g_bdt_elem),
                    (sizeof(BDT_ELEM) * ((64) >> 1)),
                    (uint_8)(0xffffffff));

     
    Clear_Mem((uint_8_ptr)g_bdtmap,(uint_32) (1024), (uint_8)0);

     
    g_bdt_address = ((uint_32)g_bdtmap + (512));

    g_trf_direction = (0xFF);
    ...
    ((((USB_MemMapPtr)0x40072000u))->CTL1) &= ~0x20u;

#line 273 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
}
...
)
{
    ...
    buffer_dsc->cnt = (current_count);

    buffer_dsc->addr = ((uint_32)buff_ptr);
}
...
#line 445 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    ...
    ((((USB_MemMapPtr)0x40072000u))->BDTPAGE1) = (uint_8)(((uint_32)g_bdtmap >> 8)& 0xFE);
    ((((USB_MemMapPtr)0x40072000u))->BDTPAGE2) = (uint_8)((uint_32)g_bdtmap >> 16);
    ((((USB_MemMapPtr)0x40072000u))->BDTPAGE3) = (uint_8)((uint_32)g_bdtmap >> 24);
    ...
    ((((USB_MemMapPtr)0x40072000u))->CTL1) = 0x1u; 	 
    ...
    ((((USB_MemMapPtr)0x40072000u))->CTL0) = 0x80u | 0;
#line 515 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return (0x00);
}
...
#line 545 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
)
{
    ...
    bdtmap_index = USB_DCI_Get_BDT_Index(ep_num, direction,
        (0));
    bdtelem_index = (uint_8)(bdtmap_index>>1);

    


 
    if((bdtmap_index  == (0xff)) ||
       (g_bdt_elem[bdtelem_index].len != (uint_16)(0xffffffff)) ||
       (ep_ptr->type > (0x03)) ||
       (ep_ptr->direction > (1)))
    {
        return (0x95);
    ...
    if(bdt_elem->bdtmap_index == (uint_8)(0xffffffff))
    {
    ...
    temp->cnt = ((uint_16)ep_ptr->size);
    temp->addr = (g_bdt_address);
    temp->Stat._byte = ((0x00) | (0x00) | (0x08));
    ...
    temp->cnt = ((uint_16)ep_ptr->size);
    temp->addr = (g_bdt_address);
    temp->Stat._byte = ((0x00) | (0x40) | (0x08));
    ...
    if(direction == (0))
    {
        ...
        temp = &g_bdtmap->ep_dsc[bdt_elem->bdtmap_index];
        temp->Stat._byte |= (0x80);
    }

     
    ep_ctrl[direction] |= ((ep_ptr->type != (0x01)) ?
        (0x01):0x00);
     
    *((&((((USB_MemMapPtr)0x40072000u))->ENDPOINT[0]. ENDPT)) + (4 * ep_num)) |= ep_ctrl[direction];
#line 709 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return (0x00);
}
...
)
{
    ...
    uint_8 bdt_index = USB_DCI_Validate_Param (endpoint_number, direction,
        (0));
    uint_8 bdtelem_index = (uint_8)(bdt_index>>1);
    (void)handle;;
    ...
    if(bdt_index != (0xff))
    {
        ...
        buffer_dsc->Stat._byte &= ~(0x80);
        buffer_dsc_alt->Stat._byte &= ~(0x80);
        bdt_elem->app_len = (uint_16)(0xffffffff);

        status = (0x00);
    }
    return status;
#line 766 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
}
...
)
{
    ...
    _usb_device_cancel_transfer(&controller_ID, ep_num, direction);
     
    g_bdt_address -= (g_bdt_elem[bdtelem_index].len);

     
    *((&((((USB_MemMapPtr)0x40072000u))->ENDPOINT[0]. ENDPT)) + (4 * ep_num)) = (0);

     
    g_bdt_elem[bdtelem_index].len = (uint_16)(0xffffffff);
    g_bdt_elem[bdtelem_index].addr = (uint_32)(0xffffffff);
#line 835 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return (0x00);
}
...
)
{
    ...
    P_BDT_ELEM bdt_elem = &g_bdt_elem[(bdt_index>>1)];
    bdt_index = bdt_elem->bdtmap_index;

     
	if(bdt_index != (0xff))
    {
        (void)_usb_device_cancel_transfer(handle, endpoint_number, direction);

         
        g_bdtmap->ep_dsc[bdt_index].Stat._byte |= ((0x80) | (0x04));
    }
#line 885 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return;
}
...
)
{
	...
	if(bdt_index != (0xff))
	{
        ENDPT0STR *endpoint = (ENDPT0STR*)(&((((USB_MemMapPtr)0x40072000u))->ENDPOINT[0]. ENDPT) + (4 * endpoint_number));
        ...
        if(endpoint_number != (0))
        {
            ...
            endpt = (uint_8)((bdt_elem->type != (0x01)) ?
                (0x01):0);
        ...
        g_bdtmap->ep_dsc[bdt_index].Stat._byte = (0x00);
	    if(direction == (0))
	    {
	         
	        _usb_device_recv_data(handle, endpoint_number, 0, 0);
	    } 	
    }
#line 968 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return;
}
...
)
{
    ...
    uint_8 bdt_index = USB_DCI_Validate_Param (endpoint_number, (0),
        (0));
    ...
    addr = (uint_8_ptr)(g_bdtmap->ep_dsc[bdt_index]. addr);

     
    (void)memcpy(buffer_ptr, addr, (8));
    return;
...
)
{
	...
	if(bdt_index != (0xff))
    {
        uint_8 ep_control = (uint_8)(*((&((((USB_MemMapPtr)0x40072000u))->ENDPOINT[0]. ENDPT))+4*endpoint_number));

        status = (0);

         
        if((ep_control & ((0x04)|(0x08))) == (0))
        {
            status = (5);
        }
         
        else if ((ep_control &  (0x02)) == (0x02))
        {
            status = (1) ;
        }
...
#line 1082 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    return status;
}
...
void  _usb_device_clear_data0_endpoint (    
    uint_8                endpoint_number,     
    uint_8                direction            
)
{
	...
	uint_8 bdt_index = USB_DCI_Validate_Param(endpoint_number, direction, (0));	
	P_BDT_ELEM bdt_elem = &g_bdt_elem[(bdt_index>>1)];		
...
)
{
    ...
    uint_8 bdt_index = USB_DCI_Validate_Param (endpoint_number, (0), (0));
    P_BDT_ELEM bdt_elem = &g_bdt_elem[(bdt_index>>1)];
    ...
    if(bdt_index != (0xff))
    {
        ...
        P_BUFF_DSC buffer_dsc_alt = 0;

         
        if(bdt_elem->len != (uint_16)(0xffffffff))
        {
            ...
            if(buffer_dsc->Stat.SieCtlBit.own == 0)
            {
                if(size == 0)
                {
                    ...
                    buffer_dsc_alt->cnt = (bdt_elem->len);
                    buffer_dsc_alt->addr = (bdt_elem->addr);
                ...
                buffer_dsc_alt = &g_bdtmap->ep_dsc[bdt_index];
                buffer_dsc_alt->cnt = (size);
                buffer_dsc_alt->addr = ((uint_32)buffer_ptr);
                buffer_dsc_alt->Stat._byte = (uint_8)(
                    (buffer_dsc_alt->Stat.McuCtlBit.data << 6) |
                    (0x80) | (0x08));
                status = (0x00);
    ...
    return status;
#line 1232 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
}
...
)
{
    ...
    uint_8 bdt_index = USB_DCI_Validate_Param (endpoint_number, (1), (0));
    P_BDT_ELEM bdt_elem = &g_bdt_elem[(bdt_index>>1)];
    ...
    if(!((buffer_dsc->Stat.SieCtlBit.own) || 
       (*(&((((USB_MemMapPtr)0x40072000u))->ENDPOINT[0]. ENDPT) + (endpoint_number * 4)) & (0x02))))
    {
...
#line 1303 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
        if(endpoint_number == (0))
        {
             
            buffer_dsc->Stat._byte = ((0x80) | (0x40) | (0x08));
        }
        else
        {
    ...
    return status;
#line 1335 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
}
...
)
{
    ...
    _usb_device_set_status(&g_dci_controller_Id, (0x01),
        (0x01));
    return;
}
...
)
{
	...
	((((USB_MemMapPtr)0x40072000u))->CTL1) = 0;
     


	((((USB_MemMapPtr)0x40072000u))->USBTRC0) = (0x80);
...
)
{
    ...
    { ((((USB_MemMapPtr)0x40072000u))->ISTAT) |= 0x20u; ((((USB_MemMapPtr)0x40072000u))->INTEN) &= ~0x20u; ((((USB_MemMapPtr)0x40072000u))->CTL1) &= ~0x20u; }
...
{
    uint_8 bdt_index = 0 ;
    P_BUFF_DSC buffer_dsc = 0;
    P_BUFF_DSC buffer_dsc_alt = 0; 
    P_BDT_ELEM bdt_elem = 0;
    boolean odd = (boolean)((stat & 0x04) >> 2);

     
    event->direction = (uint_8)((stat & (0x08)) >>
        (3));
    ...
    bdt_elem = &g_bdt_elem[(bdt_index>>1)];

     
    event->buffer_ptr = (uint_8_ptr)(buffer_dsc->addr);
    ...
    if(event->direction == (1))
    {
        if(event->ep_num == (0))
        {
            ...
            if(g_trf_direction == (0))
            {
                ...
                _usb_device_cancel_transfer(&(event->controller_ID), (uint_8)(0),
                  (uint_8)(0));
                 
                buffer_dsc_alt->Stat._byte = (0x00);
                 
                _usb_device_recv_data(&(event->controller_ID),
                    (0),
                    0,0);
            ...
            (event->ep_num != (0)) )
        {
            ...
            if ((bdt_elem->app_len > bdt_elem->curr_offset) ||
                 (((uint_8)event->len == bdt_elem->len) && (bdt_elem->flag == 1))
               )
            {
    ...
    else  
    {
        if(event->ep_num == (0))
        {
            ...
            if(buffer_dsc->Stat.RecPid.pid == (0x0d))
            {
        ...
        if(bdt_elem->app_len != (uint_16)(0xffffffff))
        {
             
            uint_16 size = event->len;
              ...
              )
            {
				...
				{
                    buffer_dsc_alt->addr = ((uint_32)(bdt_elem->app_buffer + bdt_elem->curr_offset));
				    buffer_dsc_alt->cnt = (count);
				}
...
#line 1774 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
...
void USB_ISR(void)
{
    ...
    uint_8 v1 = ((((USB_MemMapPtr)0x40072000u))->ISTAT);
    uint_8 v2 = ((((USB_MemMapPtr)0x40072000u))->INTEN);
    uint_8 intr_stat = (uint_8)(v1 & v2);
    uint_8 stat = (uint_8)((((USB_MemMapPtr)0x40072000u))->STAT);
    USB_DEV_EVENT_STRUCT event;
    uint_8 dev_state = (0xFF);
    ...
    event.ep_num = (uint_8)(0xffffffff);

     
    (void)_usb_device_get_status(&g_dci_controller_Id, (0x01),
        &dev_state);

     
    if((((((USB_MemMapPtr)0x40072000u))->USBTRC0) & 0x1u) && (dev_state == (0x80)))
    {
    ...
    if(((intr_stat) & 4))
    {
		...
		tmp1 = ((((USB_MemMapPtr)0x40072000u))->FRMNUMH);
		tmp2 = (8);
		tmp3 = ((((USB_MemMapPtr)0x40072000u))->FRMNUML);
        ...
        (void)USB_Device_Call_Service((0x12), &event);

#line 1847 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
    }
    ...
    if(((intr_stat) & 1))
    {
        ...
        (void)USB_Device_Call_Service((0x10), &event);
    ...
    if(((intr_stat) & 2))
    {
		...
		v1 = ((((USB_MemMapPtr)0x40072000u))->ERRSTAT);
		v2 = ((((USB_MemMapPtr)0x40072000u))->ERREN);
        event.errors = (uint_8)(v1 & v2);

         
       (void)USB_Device_Call_Service((0x16), &event);
    ...
    if(((intr_stat) & 0x10))
    {
        ...
        (void)USB_Device_Call_Service((0x14), &event);
    ...
    if(((intr_stat) & 0x20))
    {
        ...
        (void)USB_Device_Call_Service((0x13), &event);
    ...
    if(((intr_stat) & 0x80))
    {
        ...
        (void)USB_Device_Call_Service((0x17), &event);
...
#line 2039 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_dci_kinetis.c"
