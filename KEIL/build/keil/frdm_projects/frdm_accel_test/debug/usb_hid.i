#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\class\\usb_hid.c"
...
#line 39 "..\\..\\..\\..\\src\\drivers\\usbd\\class\\usb_hid.c"
#line 40 "..\\..\\..\\..\\src\\drivers\\usbd\\class\\usb_hid.c"
...
static USB_CLASS_CALLBACK g_hid_class_callback=0;
 
static USB_REQ_FUNC       g_vendor_req_callback=0;
 
static USB_CLASS_SPECIFIC_HANDLER_FUNC g_param_callback = 0;
...
uint_8 g_class_request_params[2];  
...
)
{
    ...
    else
    {
        ...
        g_hid_class_callback(event->controller_ID, (5),
            (uint_8*)(&(event->errors)));
    }
    ...
    g_hid_class_callback( event->controller_ID, (3), (uint_8*)(&(event->ep_num)));  
}
...
#line 224 "..\\..\\..\\..\\src\\drivers\\usbd\\class\\usb_hid.c"
        ...
        for(count=index_num;count<ep_count+index_num;count++)
        {
            ...
            (void)_usb_device_register_service(controller_ID,
                                  (uint_8)((0x00)+ep_struct->ep_num),
                                                             USB_Service_Hid);


             
            (void)_usb_device_set_status(&controller_ID,
                (uint_8)((0x10) | ep_struct->ep_num |
                (ep_struct->direction << (7))),
                (0));
        }
...
)
{
    ...
    *((uint_32_ptr)rpt_buf) = 0;
    ...
    if((setup_packet->request_type & (0x60)) ==
        (0x20))
    {
    ...
    else if((setup_packet->request_type & (0x60)) ==
        (0x40))
    {
         
        if(g_vendor_req_callback != 0)
        {
...
{
    uint_8 index,status = (0x00);
    USB_ENDPOINTS *ep_desc_data = (USB_ENDPOINTS *)
        USB_Desc_Get_Endpoints(controller_ID);
    

     
    status = _usb_device_init(controller_ID, 0,
        (uint_8)(ep_desc_data->count+1), 1);
    if(status == (0x00))
    {
...
) 
{
    ...
    g_hid_class_callback = 0;
    
     
    g_vendor_req_callback = 0;
...
)
{
    ...
    if((uint_8)(producer - consumer) != (uint_8)((4)))
    {
         

        uint_8 queue_num = (uint_8)(producer % (4));
