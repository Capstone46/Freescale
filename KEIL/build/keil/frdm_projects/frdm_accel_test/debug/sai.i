...
static SAI_CALLBACK     volatile pCallbackSAI0=0;
...
{     
  ...
  { 
    pCallbackSAI0 = pC1; 
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_I2S0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_I2S0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_I2S0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_I2S0)-16)%4)<<3)+6)); }; 
  }
  
     
  ((((I2S_MemMapPtr)0x4002F000u))->TCSR) = i2s.TCSR;

  ((((I2S_MemMapPtr)0x4002F000u))->TCR2) = i2s.TCR2;
  ((((I2S_MemMapPtr)0x4002F000u))->TCR3) = i2s.TCR3;
  ((((I2S_MemMapPtr)0x4002F000u))->TCR4) = i2s.TCR4;
  ((((I2S_MemMapPtr)0x4002F000u))->TCR5) = i2s.TCR5;
  ((((I2S_MemMapPtr)0x4002F000u))->TDR[0]) = i2s.TDR0;

  ((((I2S_MemMapPtr)0x4002F000u))->TMR)  = i2s.TMR; 
  ((((I2S_MemMapPtr)0x4002F000u))->RCSR) = i2s.RCSR;

  ((((I2S_MemMapPtr)0x4002F000u))->RCR2) = i2s.RCR2;
  ((((I2S_MemMapPtr)0x4002F000u))->RCR3) = i2s.RCR3;
  ((((I2S_MemMapPtr)0x4002F000u))->RCR4) = i2s.RCR4;
  ((((I2S_MemMapPtr)0x4002F000u))->RCR5) = i2s.RCR5;
  ((((I2S_MemMapPtr)0x4002F000u))->RDR[0]) = i2s.RDR0;

  ((((I2S_MemMapPtr)0x4002F000u))->RMR)  = i2s.RMR; 
  ((((I2S_MemMapPtr)0x4002F000u))->MCR)  = i2s.MCR; 
  ((((I2S_MemMapPtr)0x4002F000u))->MDR)  = i2s.MDR; 
  
   
  ((((I2S_MemMapPtr)0x4002F000u))->TCSR) |= 0x1000000u;
  ((((I2S_MemMapPtr)0x4002F000u))->TCSR) &= ~0x1000000u;
   
  ((((I2S_MemMapPtr)0x4002F000u))->RCSR) |= 0x1000000u;
  ((((I2S_MemMapPtr)0x4002F000u))->RCSR) &= ~0x1000000u;
...
{
  ((((I2S_MemMapPtr)0x4002F000u))->TCSR) |= (0x80000000u | 0x200u);
  ((((I2S_MemMapPtr)0x4002F000u))->TCR3) |= 0x10000u;
}
...
int SAI0_SetSampleRate(int smprate)
{
  ...
  ((((I2S_MemMapPtr)0x4002F000u))->MCR) &= ~0x40000000u; 
   
   
  while(((((I2S_MemMapPtr)0x4002F000u))->MCR) & 0x80000000u)
  {};
   ((((I2S_MemMapPtr)0x4002F000u))->MDR) = 0;
  
  while(((((I2S_MemMapPtr)0x4002F000u))->MCR) & 0x80000000u)
  {};
  
   
  ((((I2S_MemMapPtr)0x4002F000u))->TCR2) &= ~0xFFu;
  ((((I2S_MemMapPtr)0x4002F000u))->TCR2) |= (((uint32_t)(((uint32_t)(samples_descr[srIx]. bitClockDivider))<<0))&0xFFu);
...
void sai0_isr (void)
{
  ...
  register uint32 tcsr = ((((I2S_MemMapPtr)0x4002F000u))->TCSR);
  register uint32 rcsr = ((((I2S_MemMapPtr)0x4002F000u))->RCSR);
  
  
  if (pCallbackSAI0 != (SAI_CALLBACK)0)
  {
 ...
 ((((I2S_MemMapPtr)0x4002F000u))->TCSR) |= 0x100000u | 0x80000u | 0x40000u;  
