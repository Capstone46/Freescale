...
#line 16 "..\\..\\..\\..\\src\\drivers\\uart\\uart.c"
...
#line 17 "..\\..\\..\\..\\src\\drivers\\uart\\uart.c"
...
static UART_CALLBACK volatile pCallbackUART=0;
...
{   
  ((((UART_MemMapPtr)0x4006C000u))->C2) &= ~(0x8u|0x4u );   
  if (pCallback != 0) { pCallbackUART = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_UART0_FLEXIO)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_UART0_FLEXIO)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_UART0_FLEXIO)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_UART0_FLEXIO)-16)%4)<<3)+6)); };} 
  else { { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_UART0_FLEXIO)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_UART0_FLEXIO)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_UART0_FLEXIO)-16)%4)<<3)+6))); };}
  ((((UART_MemMapPtr)0x4006C000u))->BDH)     = sci.BDH;
  ((((UART_MemMapPtr)0x4006C000u))->BDL)     = sci.BDL;
  ((((UART_MemMapPtr)0x4006C000u))->C1)      = sci.C1;
  ((((UART_MemMapPtr)0x4006C000u))->S2)      = sci.S2;
  ((((UART_MemMapPtr)0x4006C000u))->C3)      = sci.C3;
  ((((UART_MemMapPtr)0x4006C000u))->MA1)     = sci.MA1;
  ((((UART_MemMapPtr)0x4006C000u))->MA2)     = sci.MA2;
  ((((UART_MemMapPtr)0x4006C000u))->C4)      = sci.C4;
  ((((UART_MemMapPtr)0x4006C000u))->C2)      = sci.C2;                            
  { ((((UART_MemMapPtr)0x4006C000u))->S2) |= (uint8)((0xC01F>>8)&0xC0); ((((UART_MemMapPtr)0x4006C000u))->S1) |= (uint8)((0xC01F>>0)&0x1f); };
}
...
void uart_isr (void)
{
  ...
  if (pCallbackUART != (UART_CALLBACK)0) 
  { 
    temp = ((((UART_MemMapPtr)0x4006C000u))->S1) & (((((UART_MemMapPtr)0x4006C000u))->C2) & (0x20u|0x40u|                                             0x80u)); 
    ...
    temp = ((((UART_MemMapPtr)0x4006C000u))->S1) & (((((UART_MemMapPtr)0x4006C000u))->C3) & (0x1u|0x2u|                                            0x4u|0x8u));
...
#line 227 "..\\..\\..\\..\\src\\drivers\\uart\\uart.c"
