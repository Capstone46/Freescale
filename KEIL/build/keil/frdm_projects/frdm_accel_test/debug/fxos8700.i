#line 1 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
...
#line 14 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
...
#line 15 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
...
#line 16 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
...
#line 17 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
#line 1 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.h"
...
#line 15 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.h"
...
#line 97 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.h"
...
#line 124 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.h"
...
#line 152 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.h"
...
#line 18 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"

static uint8 FXOS8700_enabled = 0;
...
{
 if(FXOS8700_enabled != 1)
 {
  (void)I2C0_WriteByte(0x1F,0x2A,0x01);
  whoiam = (FXOS8700_IDS)(uint8)I2C0_ReadByte(0x1F,0x0D);
  FXOS8700_enabled = 1;
 }
}
...
void FXOS8700_I2C1_Init(void)
{
 if(FXOS8700_enabled != 1)
 {
  (void)I2C1_WriteByte(0x1F,0x2A,0x01);
  whoiam = (FXOS8700_IDS)(uint8)I2C1_ReadByte(0x1F,0x0D);
  FXOS8700_enabled = 1;
 }
}
...
{
  (void)I2C0_WriteByte(0x1F,0x2A,0x00);
  FXOS8700_enabled = 0;
}
...
{
  (void)I2C1_WriteByte(0x1F,0x2A,0x00);
  FXOS8700_enabled = 0;
}
...
void FXOS8700_I2C0_DynamicRange (uint8 mask)
{
  ...
  FXOS8700_I2C0_Standby();
  n = (uint8)I2C0_ReadByte(0x1F,0x0E);
  (void)I2C0_WriteByte(0x1F,0x0E,n & ~0x03);
  n = (uint8)I2C0_ReadByte(0x1F,0x0E);
  (void)I2C0_WriteByte(0x1F,0x0E,n | mask);
  FXOS8700_I2C0_Active();
}
...
void FXOS8700_I2C1_DynamicRange (uint8 mask)
{
  ...
  FXOS8700_I2C1_Standby();
  n = (uint8)I2C1_ReadByte(0x1F,0x0E);
  (void)I2C1_WriteByte(0x1F,0x0E,n & ~0x03);
  n = (uint8)I2C1_ReadByte(0x1F,0x0E);
  (void)I2C1_WriteByte(0x1F,0x0E,n | mask);
  FXOS8700_I2C1_Active();
}
...
void FXOS8700_I2C0_AutoWake (uint8 mask)
{
  ...
  FXOS8700_I2C0_Standby();
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n & ~0x03<<6);
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n | mask);
  FXOS8700_I2C0_Active();
}
...
void FXOS8700_I2C1_AutoWake (uint8 mask)
{
  ...
  FXOS8700_I2C1_Standby();
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n & ~0x03<<6);
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n | mask);
  FXOS8700_I2C1_Active();
}
...
void FXOS8700_I2C0_DataRate (uint8 mask)
{
  ...
  FXOS8700_I2C0_Standby();
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n & ~0x07<<3);
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n | mask);
  FXOS8700_I2C0_Active();
}
...
void FXOS8700_I2C1_DataRate (uint8 mask)
{
  ...
  FXOS8700_I2C1_Standby();
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n & ~0x07<<3);
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n | mask);
  FXOS8700_I2C1_Active();
}
...
void FXOS8700_I2C0_LowNoiseEnable (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n | 0x01<<2);
}
...
void FXOS8700_I2C1_LowNoiseEnable (void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n | 0x01<<2);
}
...
void FXOS8700_I2C0_FastReadEnable (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n | 0x01<<1);
}
...
void FXOS8700_I2C1_FastReadEnable (void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n | 0x01<<1);
}
...
void FXOS8700_I2C0_Active (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2A);
  (void)I2C0_WriteByte(0x1F,0x2A,n | (uint8)0x01);
}
...
void FXOS8700_I2C1_Active (void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2A);
  (void)I2C1_WriteByte(0x1F,0x2A,n | (uint8)0x01);
}
...
void FXOS8700_I2C0_SelfTestEnable (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2B);
  (void)I2C0_WriteByte(0x1F,0x2B,n | 0x01<<7);
}
...
void FXOS8700_I2C1_SelfTestEnable (void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2B);
  (void)I2C1_WriteByte(0x1F,0x2B,n | 0x01<<7);
}
...
void FXOS8700_I2C0_Reset (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2B);
  (void)I2C0_WriteByte(0x1F,0x2B,n | (uint8)0x01<<6);
}
...
void FXOS8700_I2C1_Reset (void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2B);
  (void)I2C1_WriteByte(0x1F,0x2B,n | (uint8)0x01<<6);
}
...
void FXOS8700_I2C0_AutoSleepEnable (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2B);
  (void)I2C0_WriteByte(0x1F,0x2B,n | 0x01<<2);
}
...
void FXOS8700_I2C1_AutoSleepEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2B);
  (void)I2C1_WriteByte(0x1F,0x2B,n | 0x01<<2);
}
...
void FXOS8700_I2C0_OverSampling (uint8 mask)
{
  ...
  FXOS8700_I2C0_Standby();
  n = (uint8)I2C0_ReadByte(0x1F,0x2B);
  (void)I2C0_WriteByte(0x1F,0x2B,n & ~0x03|(0x03<<3));
  n = (uint8)I2C0_ReadByte(0x1F,0x2B);
  (void)I2C0_WriteByte(0x1F,0x2B,n | mask);
  FXOS8700_I2C0_Active();
}
...
void FXOS8700_I2C1_OverSampling (uint8 mask)
{
  ...
  FXOS8700_I2C1_Standby();
  n = (uint8)I2C1_ReadByte(0x1F,0x2B);
  (void)I2C1_WriteByte(0x1F,0x2B,n & ~0x03|(0x03<<3));
  n = (uint8)I2C1_ReadByte(0x1F,0x2B);
  (void)I2C1_WriteByte(0x1F,0x2B,n | mask);
  FXOS8700_I2C1_Active();
}
...
void FXOS8700_I2C0_FIFOEnable (void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<7);
}
...
void FXOS8700_I2C1_FIFOEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<7);
}
...
void FXOS8700_I2C0_WakeTransEnable(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<6);
}
...
void FXOS8700_I2C1_WakeTransEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<6);
}
...
void FXOS8700_I2C0_WakeOrientationEnable(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<5);
}
...
void FXOS8700_I2C1_WakeOrientationEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<5);
}
...
void FXOS8700_I2C0_WakePulseEnable(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<4);
}
...
void FXOS8700_I2C1_WakePulseEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<4);
}
...
void FXOS8700_I2C0_WakeFreefallMotionEnable(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<3);
}
...
void FXOS8700_I2C1_WakeFreefallMotionEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<3);
}
...
void FXOS8700_I2C0_IntPolarityHigh(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<1);
}
...
void FXOS8700_I2C1_IntPolarityHigh(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<1);
}
...
void FXOS8700_I2C0_OpenDrainEnable(void)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2C);
  (void)I2C0_WriteByte(0x1F,0x2C,n | 0x01<<0);
}
...
void FXOS8700_I2C1_OpenDrainEnable(void)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2C);
  (void)I2C1_WriteByte(0x1F,0x2C,n | 0x01<<0);
}
...
void FXOS8700_I2C0_InterruptEnable(uint8 mask)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2D);
  (void)I2C0_WriteByte(0x1F,0x2D,n | mask);
}
...
void FXOS8700_I2C1_InterruptEnable(uint8 mask)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2D);
  (void)I2C1_WriteByte(0x1F,0x2D,n | mask);
}
...
void FXOS8700_I2C0_InterruptOnINT1(uint8 mask)
{
  ...
  n = (uint8)I2C0_ReadByte(0x1F,0x2E);
  (void)I2C0_WriteByte(0x1F,0x2E,n | mask);
}
...
void FXOS8700_I2C1_InterruptOnINT1(uint8 mask)
{
  ...
  n = (uint8)I2C1_ReadByte(0x1F,0x2E);
  (void)I2C1_WriteByte(0x1F,0x2E,n | mask);
}
...
void FXOS8700_I2C0_HPF_CutOff (uint8 mask)
{
  ...
  FXOS8700_I2C0_Standby();
  n = (uint8)I2C0_ReadByte(0x1F,0x0F);
  (void)I2C0_WriteByte(0x1F,0x0F,n & ~0x03);
  n = (uint8)I2C0_ReadByte(0x1F,0x0F);
  (void)I2C0_WriteByte(0x1F,0x0F,n | mask);
  FXOS8700_I2C0_Active();
}
...
void FXOS8700_I2C1_HPF_CutOff (uint8 mask)
{
  ...
  FXOS8700_I2C1_Standby();
  n = (uint8)I2C1_ReadByte(0x1F,0x0F);
  (void)I2C1_WriteByte(0x1F,0x0F,n & ~0x03);
  n = (uint8)I2C1_ReadByte(0x1F,0x0F);
  (void)I2C1_WriteByte(0x1F,0x0F,n | mask);
  FXOS8700_I2C1_Active();
}
...
void FXOS8700_I2C0_OutputDataFilterType (uint8 mask)
{
  ...
  {
    n = (uint8)I2C0_ReadByte(0x1F,0x0E);
    (void)I2C0_WriteByte(0x1F,0x0E,n | 0x10);
  }
  else
  {
    n = (uint8)I2C0_ReadByte(0x1F,0x0E);
...
void FXOS8700_I2C1_OutputDataFilterType (uint8 mask)
{
  ...
  {
    n = (uint8)I2C1_ReadByte(0x1F,0x0E);
    (void)I2C1_WriteByte(0x1F,0x0E,n | 0x10);
  }
  else
  {
    n = (uint8)I2C1_ReadByte(0x1F,0x0E);
...
void FXOS8700_I2C0_ReadRawData(TWR_FXOS8700* ptr_fxos8700)
{
  ...
  if(FXOS8700_enabled == 1)
  {
    if((uint8)I2C0_ReadByte(0x1F,0x00) & 0x88)
    {
      
      (void)I2C0_ReadMultiBytes(0x1F,(0x01),((uint8*)&(xyz_regs[0]. Bytes . hi)),(6));
    ...
    {
      for(ix=0; ix<50; ix++)
        ptr_fxos8700->registers[ix] = (uint8)I2C0_ReadByte(0x1F,ix);
      measure = 10;
    }
    switch(whoiam)
    {
#line 997 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
			case  FXOS8700_ID:
    ...
    if( ((int16)(ptr_fxos8700->x - workaround.x)) > 1000 ||        ((int16)(ptr_fxos8700->x - workaround.x)) < -1000 )

      ptr_fxos8700->x = workaround.x;
    if( ((int16)(ptr_fxos8700->y - workaround.y)) > 1000 ||         (int16)(ptr_fxos8700->y - workaround.y) < -1000 )

      ptr_fxos8700->y = workaround.y;
    if( (int16)(ptr_fxos8700->z - workaround.z) > 1000 ||        (int16)(ptr_fxos8700->z - workaround.z) < -1000 )

      ptr_fxos8700->z = workaround.z;
    if(latest_write != ptr_fxos8700->reg_write ||       latest_address != ptr_fxos8700->reg_addr)

    {
      (void)I2C0_WriteByte(0x1F,ptr_fxos8700->reg_addr,ptr_fxos8700->reg_write);
...
void FXOS8700_I2C1_ReadRawData(TWR_FXOS8700* ptr_fxos8700)
{
  uint8 ix;
  static uint8 measure = 0;
  static TWR_FXOS8700_DATA xyz_regs[3];
  static uint8 latest_write;
  static uint8 latest_address;
  ...
  if(FXOS8700_enabled == 1)
  {
    if((uint8)I2C1_ReadByte(0x1F,0x00) & 0x88)
    {
      
      (void)I2C1_ReadMultiBytes(0x1F,(0x01),((uint8*)&(xyz_regs[0]. Bytes . hi)),(6));
    ...
    {
      for(ix=0; ix<50; ix++)
        ptr_fxos8700->registers[ix] = (uint8)I2C1_ReadByte(0x1F,ix);
      measure = 10;
    }
    switch(whoiam)
    {
#line 1072 "..\\..\\..\\..\\src\\devices\\fxos8700\\fxos8700.c"
    case  FXOS8700_ID:
        workaround.x = (int16)(xyz_regs[0].all);
        workaround.y = (int16)(xyz_regs[1].all);
        workaround.z = (int16)(xyz_regs[2].all);
    ...
    {
      (void)I2C1_WriteByte(0x1F,ptr_fxos8700->reg_addr,ptr_fxos8700->reg_write);
      latest_write = ptr_fxos8700->reg_write;
      latest_address = ptr_fxos8700->reg_addr;
    }
    ptr_fxos8700->id = whoiam;
