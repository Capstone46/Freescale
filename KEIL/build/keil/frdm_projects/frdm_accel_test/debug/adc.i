...
#line 15 "..\\..\\..\\..\\src\\drivers\\adc\\adc.c"



 
static ADC_CALLBACK volatile pCallbackADC0=0;
...
void ADC0_Init  (tADC adc, tADC_CH CHA, tADC_CH CHB, uint8 ip, ADC_CALLBACK pCallback)
{
  ...
  { 
    ...
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_ADC0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_ADC0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_ADC0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_ADC0)-16)%4)<<3)+6)); }; 
  }
  else
  { 
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_ADC0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_ADC0)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_ADC0)-16)%4)<<3)+6))); };
  }
  ((((ADC_MemMapPtr)0x4003B000u))->CFG1) = adc.CFG1;
  ((((ADC_MemMapPtr)0x4003B000u))->CFG2) = adc.CFG2;
  ((((ADC_MemMapPtr)0x4003B000u))->CV1)  = adc.CV1;
  ((((ADC_MemMapPtr)0x4003B000u))->CV2)  = adc.CV2;
  ((((ADC_MemMapPtr)0x4003B000u))->SC2)  = adc.SC2;
  ((((ADC_MemMapPtr)0x4003B000u))->SC3)  = adc.SC3;
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) = CHA.SC1;
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[1]) = CHB.SC1;  
}
...
int ADC0_ExecCalib (tADC adc, tADC_CALIB *pCALIB)
{
  ...
  register uint16 i=0, numLoops = ((uint16)1<<6);
  
  ((((ADC_MemMapPtr)0x4003B000u))->CFG1) = adc.CFG1;
  ((((ADC_MemMapPtr)0x4003B000u))->CFG2) = adc.CFG2;
  ((((ADC_MemMapPtr)0x4003B000u))->SC2)  = (adc.SC2 & (~0x40u));
  ...
  { 
    ...
    ((((ADC_MemMapPtr)0x4003B000u))->SC3)  = (adc.SC3 & (~0x80u));
    ((((ADC_MemMapPtr)0x4003B000u))->SC3) |= 0x80u;
    while (!(((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) & 0x80u));
    if (((((ADC_MemMapPtr)0x4003B000u))->SC3) & 0x40u) { ((((ADC_MemMapPtr)0x4003B000u))->SC3) |= 0x40u; return 1; }
    
    tmp+= (short int)((((ADC_MemMapPtr)0x4003B000u))->OFS);
    
    tmp_1[0]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLP0);
    tmp_1[1]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLP1);
    tmp_1[2]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLP2);
    tmp_1[3]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLP3);
    tmp_1[4]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLP4);
    tmp_1[5]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLPS);
    tmp_1[6]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLPD);
    
    tmp_2[0]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLM0);
    tmp_2[1]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLM1);
    tmp_2[2]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLM2);
    tmp_2[3]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLM3);
    tmp_2[4]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLM4);
    tmp_2[5]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLMS);
    tmp_2[6]+=(unsigned long)((((ADC_MemMapPtr)0x4003B000u))->CLMD);
  }
  pCALIB->OFS  = tmp >> 6;
  
  pCALIB->CLP[0] = tmp_1[0] >> 6;  
  pCALIB->CLP[1] = tmp_1[1] >> 6;  
  pCALIB->CLP[2] = tmp_1[2] >> 6;  
  pCALIB->CLP[3] = tmp_1[3] >> 6;  
  pCALIB->CLP[4] = tmp_1[4] >> 6;  
  pCALIB->CLPS   = tmp_1[5] >> 6;  
  pCALIB->CLPD   = tmp_1[6] >> 6;    
  
  tmp = tmp_1[0]+tmp_1[1]+tmp_1[2]+tmp_1[3]+tmp_1[4]+tmp_1[5];
  pCALIB->PG  = ((tmp>>(1+6))|0x8000);
  
  pCALIB->CLM[0] = tmp_2[0] >> 6;  
  pCALIB->CLM[1] = tmp_2[1] >> 6;  
  pCALIB->CLM[2] = tmp_2[2] >> 6;  
  pCALIB->CLM[3] = tmp_2[3] >> 6;  
  pCALIB->CLM[4] = tmp_2[4] >> 6;  
  pCALIB->CLMS   = tmp_2[5] >> 6;  
  pCALIB->CLMD   = tmp_2[6] >> 6;    
  
  tmp = tmp_2[0]+tmp_2[1]+tmp_2[2]+tmp_2[3]+tmp_2[4]+tmp_2[5];
  pCALIB->MG  = ((tmp>>(1+6))|0x8000);
  
  ADC0_SaveCalib(pCALIB);      
...
void ADC0_SaveCalib (tADC_CALIB *pCALIB)
{
  ((((ADC_MemMapPtr)0x4003B000u))->CLP0) = pCALIB->CLP[0]; 
  ((((ADC_MemMapPtr)0x4003B000u))->CLP1) = pCALIB->CLP[1];
  ((((ADC_MemMapPtr)0x4003B000u))->CLP2) = pCALIB->CLP[2];
  ((((ADC_MemMapPtr)0x4003B000u))->CLP3) = pCALIB->CLP[3];
  ((((ADC_MemMapPtr)0x4003B000u))->CLP4) = pCALIB->CLP[4];
  ((((ADC_MemMapPtr)0x4003B000u))->CLPS) = pCALIB->CLPS;
  ((((ADC_MemMapPtr)0x4003B000u))->CLPD) = pCALIB->CLPD;  
  ((((ADC_MemMapPtr)0x4003B000u))->CLM0) = pCALIB->CLM[0];
  ((((ADC_MemMapPtr)0x4003B000u))->CLM1) = pCALIB->CLM[1];
  ((((ADC_MemMapPtr)0x4003B000u))->CLM2) = pCALIB->CLM[2];
  ((((ADC_MemMapPtr)0x4003B000u))->CLM3) = pCALIB->CLM[3];
  ((((ADC_MemMapPtr)0x4003B000u))->CLM4) = pCALIB->CLM[4];
  ((((ADC_MemMapPtr)0x4003B000u))->CLMS) = pCALIB->CLMS;
  ((((ADC_MemMapPtr)0x4003B000u))->CLMD) = pCALIB->CLMD;
  ((((ADC_MemMapPtr)0x4003B000u))->PG)   = pCALIB->PG; 
  ((((ADC_MemMapPtr)0x4003B000u))->MG)   = pCALIB->MG; 
  ((((ADC_MemMapPtr)0x4003B000u))->OFS)  = pCALIB->OFS;     
}
...
void adc0_isr (void) 
{ 
  if (pCallbackADC0 != (ADC_CALLBACK)0) 
  { 
    if (((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) & 0x80u) { pCallbackADC0 (CHA_CALLBACK, ((((ADC_MemMapPtr)0x4003B000u))->R[0])); }
    if (((((ADC_MemMapPtr)0x4003B000u))->SC1[1]) & 0x80u) { pCallbackADC0 (CHB_CALLBACK, ((((ADC_MemMapPtr)0x4003B000u))->R[1])); }
  }
}
