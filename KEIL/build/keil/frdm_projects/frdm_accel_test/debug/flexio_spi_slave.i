#line 1 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio_spi_slave\\flexio_spi_slave.c"
...
#line 14 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio_spi_slave\\flexio_spi_slave.c"
...
#line 15 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio_spi_slave\\flexio_spi_slave.c"
#line 16 "..\\..\\..\\..\\src\\drivers\\flexio\\flexio_spi_slave\\flexio_spi_slave.c"
                                              ...
                                              )
{
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])&~0x3000000u)|(pConfig->timerIx<<24)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])&~0x30000u)|(0x0<<16)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMosiIx])&~0x7u)|(0x1<<0)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[pConfig->shifterMosiIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[pConfig->shifterMosiIx])&~0x30u)|(0x0<<4)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[pConfig->shifterMosiIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCFG[pConfig->shifterMosiIx])&~0x3u)|(0x0<<0)); };;
  
   
  
  
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCMP[pConfig->timerIx])&~0xFFFFu)|(((8 * 2) - 1)<<0)); };;
  ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMIEN) &= 0xFu&(~(1<<(pConfig->timerIx)));;
  
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x3000000u)|(0x1<<24)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x300000u)|(0x2<<20)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x70000u)|(0x0<<16)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x7000u)|(0x6<<12)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x700u)|(0x6<<8)); };;
  
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x30u)|(0x0<<4)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCFG[pConfig->timerIx])&~0x2u)|(0x0<<1)); };;
  

  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0xF000000u)|(((pinCsIx) * 2)<<24)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x800000u)|(0x1<<23)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x400000u)|(0x1<<22)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x30000u)|(0x0<<16)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x700u)|(pinSclkIx<<8)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x80u)|((mode & 0x02)? 0x0 : 0x1<<7)); };;
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->TIMCTL[pConfig->timerIx])&~0x3u)|(0x3<<0)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])&~0x3000000u)|(pConfig->timerIx<<24)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])&~0x30000u)|(0x3<<16)); };;
  ...
  { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTCTL[pConfig->shifterMisoIx])&~0x7u)|(0x2<<0)); };;
  ...
  callBackDesc.TIMERFLG_MASK = (1<<(pConfig->timerIx));
...
{
  if(pBuffOut == 0) return FLEXIO_SPI_SLAVE_RES_FAILED;
  pConfig->pBufferOut = pBuffOut;
  
  if(pBuffIn == 0) return FLEXIO_SPI_SLAVE_RES_FAILED;
...
FLEXIO_SPI_SLAVE_RESULT FLEXIO_SPI_SLAVE_WriteTransfer(FLEXIO_SPI_SLAVE_CONFIG * pConfig, uint32 dataLen)
{
  ...
  if(0 == pConfig->pBufferOut) return FLEXIO_SPI_SLAVE_RES_FAILED;
...
void flexio_spi_slave_isr_callback(FLEXIO_CALLBACK_TYPE type, void* user_data)
{
  ...
  if((uint32_t)type & ((1<<(pConfig->timerIx)) << 8) )
  {  
    ...
    if(!(pConfig->mode & 0x04))
    {
      ...
      if(pConfig->pBufferIn)
        pConfig->pBufferIn[pConfig->dataIx] = (uint32)((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUF[pConfig->shifterMosiIx]);
    }else
    {
      
      if(pConfig->pBufferIn)
        pConfig->pBufferIn[pConfig->dataIx] = ((uint32)((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUFBIS[pConfig->shifterMosiIx])>>24);
    }
    ...
    { 
      ...
      if(pConfig->dataOutIx++ < pConfig->dataOutLen)
      {
        if(!(pConfig->mode & 0x04))
        {
          { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUF[pConfig->shifterMisoIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUF[pConfig->shifterMisoIx])&~0xFFFFFFFFu)|(pConfig->pBufferOut[pConfig->dataOutIx]<<0)); };;
        }else
        {
          { ((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUFBIS[pConfig->shifterMisoIx])=((((((FLEXIO_MemMapPtr)0x4005F000u))->SHIFTBUFBIS[pConfig->shifterMisoIx])&~0xFFFFFFFFu)|(pConfig->pBufferOut[pConfig->dataOutIx]<<0)); };;
        }   
      }
      else {
