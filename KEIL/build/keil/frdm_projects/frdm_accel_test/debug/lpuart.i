#line 1 "..\\..\\..\\..\\src\\drivers\\lpuart\\lpuart.c"
...
#line 15 "..\\..\\..\\..\\src\\drivers\\lpuart\\lpuart.c"
...
#line 16 "..\\..\\..\\..\\src\\drivers\\lpuart\\lpuart.c"




 
static LPUART_CALLBACK volatile pCallbackLPUART0=0;
static LPUART_CALLBACK volatile pCallbackLPUART1=0;
...
{   
  ((((LPUART_MemMapPtr)0x40054000u))->CTRL) &= ~(0x80000u|0x40000u );   
  if (pCallback != 0) { pCallbackLPUART0 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_LPUART0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_LPUART0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LPUART0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_LPUART0)-16)%4)<<3)+6)); };} 
  else { { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_LPUART0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LPUART0)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_LPUART0)-16)%4)<<3)+6))); };}
  ((((LPUART_MemMapPtr)0x40054000u))->BAUD)     = sci.BAUD;
  ((((LPUART_MemMapPtr)0x40054000u))->MATCH)    = sci.MATCH;
  ((((LPUART_MemMapPtr)0x40054000u))->STAT)    = sci.STAT;
  ((((LPUART_MemMapPtr)0x40054000u))->CTRL)     = sci.CTRL;                       
  ((((LPUART_MemMapPtr)0x40054000u))->STAT) |= (uint32)((uint32)(0xC01FC000)&0xC01FC000);;
}

void LPUART1_Init (tLPUART sci, uint8 ip, LPUART_CALLBACK pCallback)
{   
  ((((LPUART_MemMapPtr)0x40055000u))->CTRL) &= ~(0x80000u|0x40000u );   
  if (pCallback != 0) { pCallbackLPUART1 = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_LPUART1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_LPUART1)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LPUART1)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_LPUART1)-16)%4)<<3)+6)); };} 
  else { { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_LPUART0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LPUART0)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_LPUART0)-16)%4)<<3)+6))); };}
  ((((LPUART_MemMapPtr)0x40055000u))->BAUD)     = sci.BAUD;
  ((((LPUART_MemMapPtr)0x40055000u))->MATCH)    = sci.MATCH;
  ((((LPUART_MemMapPtr)0x40055000u))->STAT)    = sci.STAT;
  ((((LPUART_MemMapPtr)0x40055000u))->CTRL)     = sci.CTRL;                       
  ((((LPUART_MemMapPtr)0x40055000u))->STAT) |= (uint32)((uint32)(0xC01FC000)&0xC01FC000);;
}
...
void lpuart0_isr (void)
{
  ...
  if (pCallbackLPUART0 != (LPUART_CALLBACK)0) 
  { 
    temp = ((((LPUART_MemMapPtr)0x40054000u))->STAT) & (((((LPUART_MemMapPtr)0x40054000u))->CTRL) & (0x200000u|                                           0x400000u|0x800000u)); 

    if(temp & 0x200000u)
    { 
      pCallbackLPUART0 (LPUART_RX_CALLBACK, temp);
    }
    if(temp & (0x400000u|0x800000u))
    { 
      pCallbackLPUART0 (LPUART_TX_CALLBACK, temp); 
    }
    temp = ((((LPUART_MemMapPtr)0x40054000u))->STAT) & (((((LPUART_MemMapPtr)0x40054000u))->CTRL) & (0x1000000u|                                          0x2000000u|0x4000000u|                                    0x8000000u));
...
void lpuart1_isr (void)
{
  ...
  if (pCallbackLPUART1 != (LPUART_CALLBACK)0) 
  { 
    temp = ((((LPUART_MemMapPtr)0x40055000u))->STAT) & (((((LPUART_MemMapPtr)0x40055000u))->CTRL) & (0x200000u|                                           0x400000u|0x800000u)); 
    ...
    temp = ((((LPUART_MemMapPtr)0x40055000u))->STAT) & (((((LPUART_MemMapPtr)0x40055000u))->CTRL) & (0x1000000u|                                          0x2000000u|0x4000000u|                                      0x8000000u));
