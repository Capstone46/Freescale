...
static RTC_CALLBACK volatile pCallbackRTC=0;
...
void RTC_Init(tRTC rtc,uint32 seconds,uint8 ip,RTC_CALLBACK pCallback)
{
  ...
  { 
    ...
    if (rtc.IER&0x10u)
    {
      { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_RTC_Seconds)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_RTC_Seconds)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_RTC_Seconds)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_RTC_Seconds)-16)%4)<<3)+6)); };
    }
    else
    {
      { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_RTC)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_RTC)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_RTC)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_RTC)-16)%4)<<3)+6)); };
    }
  }
  else
  {
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_RTC)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_RTC)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_RTC)-16)%4)<<3)+6))); };
    { ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = (uint32)(1 << ((INT_RTC_Seconds)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_RTC_Seconds)-16)>>2)]) &= ~((uint32)((uint32)0x03<<(uint16)(((((INT_RTC_Seconds)-16)%4)<<3)+6))); };
  }
  
  ((((RTC_MemMapPtr)0x4003D000u))->LR) |= 0x40u;
  ((((RTC_MemMapPtr)0x4003D000u))->LR) |= 0x20u|0x10u|0x8u;
  ...
  ((((RTC_MemMapPtr)0x4003D000u))->CR)  = rtc.CR;
  if(rtc.SR & 0x10u)
  {
  ...
  ((((RTC_MemMapPtr)0x4003D000u))->TCR) = rtc.TCR;
  ((((RTC_MemMapPtr)0x4003D000u))->TAR) = rtc.TAR;
  ((((RTC_MemMapPtr)0x4003D000u))->IER) = rtc.IER;
  ((((RTC_MemMapPtr)0x4003D000u))->SR)  = rtc.SR;
  ((((RTC_MemMapPtr)0x4003D000u))->LR)  = rtc.LR;
}

#line 105 "..\\..\\..\\..\\src\\drivers\\rtc\\rtc.c"
  ...
  
{
  ...
  while (day < 0) 
  {
    ...
    day += _ytab[(!((1970 + timep->tm_year) % 4) && (((1970 + timep->tm_year) % 100) || !((1970 + timep->tm_year) % 400)))][timep->tm_mon];
  }
  while (day >= _ytab[(!((1970 + timep->tm_year) % 4) && (((1970 + timep->tm_year) % 100) || !((1970 + timep->tm_year) % 400)))][timep->tm_mon]) 
  {
    day -= _ytab[(!((1970 + timep->tm_year) % 4) && (((1970 + timep->tm_year) % 100) || !((1970 + timep->tm_year) % 400)))][timep->tm_mon];
  ...
  if (2147483647l / 365 < tm_year - year) overflow++;
  day = (tm_year - year) * 365;
  if (2147483647l - day < (tm_year - year) / 4 + 1) overflow++;
  day += (tm_year - year) / 4 + ((tm_year % 4) && tm_year % 4 < year % 4);
  day -= (tm_year - year) / 100 + ((tm_year % 100) && tm_year % 100 < year % 100);
  day += (tm_year - year) / 400 + ((tm_year % 400) && tm_year % 400 < year % 400);
  yday = month = 0;
  while (month < timep->tm_mon){ yday += _ytab[(!((tm_year) % 4) && (((tm_year) % 100) || !((tm_year) % 400)))][month]; month++; }
  ...
  if ((4294967296l - seconds) / (24l * 60l * 60l) < day) overflow++;
  seconds += day * (24l * 60l * 60l);
  ...
  
{
  ...
  register int16  year = 1970;
  
  dayclock = (uint32)numSeconds % (24l * 60l * 60l);
  dayno = (uint32)numSeconds / (24l * 60l * 60l);
  timep->tm_sec = dayclock % 60;
  timep->tm_min = (dayclock % 3600) / 60;
  timep->tm_hour = dayclock / 3600;
  timep->tm_wday = (dayno + 4) % 7;        
  while (dayno >= ((!((year) % 4) && (((year) % 100) || !((year) % 400))) ? 366 : 365)) { dayno -= ((!((year) % 4) && (((year) % 100) || !((year) % 400))) ? 366 : 365); year++; }
  timep->tm_year = year;
  timep->tm_yday = dayno;
  timep->tm_mon = 0;
  while (dayno >= _ytab[(!((year) % 4) && (((year) % 100) || !((year) % 400)))][timep->tm_mon]) 
  {
    dayno -= _ytab[(!((year) % 4) && (((year) % 100) || !((year) % 400)))][timep->tm_mon];
    timep->tm_mon++;
  }
...
void rtc_isr (void) 
{  
  if (pCallbackRTC != (RTC_CALLBACK)0)
  {
    if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x4u) {   pCallbackRTC(TAF_CALLBACK); }
    if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x2u) { { if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x10u) { ((((RTC_MemMapPtr)0x4003D000u))->SR) &= ~0x10u; ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (0); ((((RTC_MemMapPtr)0x4003D000u))->SR) |= 0x10u; } else { ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (0); } }; pCallbackRTC(TOF_CALLBACK); }
    if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x1u) { { if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x10u) { ((((RTC_MemMapPtr)0x4003D000u))->SR) &= ~0x10u; ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (0); ((((RTC_MemMapPtr)0x4003D000u))->SR) |= 0x10u; } else { ((((RTC_MemMapPtr)0x4003D000u))->TSR) = (0); } }; pCallbackRTC(TIF_CALLBACK); }
