#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_class.c"
...
#line 39 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_class.c"
#line 40 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_class.c"
...
#line 41 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_class.c"
...
static USB_CLASS_CALLBACK g_class_callback = 0;
...
)
{
    ...
    (void)_usb_device_get_status(&(event->controller_ID),
        (0x01), &g_device_state_before_suspend);
     
    (void)_usb_device_set_status(&(event->controller_ID), (0x01),
        (0x80));

     
    g_class_callback(event->controller_ID, (0x0A), 0);
...
)
{
    ...
    g_class_callback(event->controller_ID, (0x0B), 0);
...
)
{
    ...
    (void)_usb_device_set_status(&(event->controller_ID), (0x05),
        (uint_8)sof_count);
    return;
}
...
)
{
    ...
    err = _usb_device_init_endpoint(&(event->controller_ID),
    		ep_struct.ep_num, (uint_16)ep_struct.size, ep_struct.direction, ep_struct.type, 1);

    ep_struct.direction = (0);
    ...
    (void)_usb_device_set_status(&(event->controller_ID), (0x06),
        (0x40) >> (6));
    ...
    g_class_callback(event->controller_ID, (0), 0);
...
)
{
    ...
    g_class_callback(event->controller_ID, (5),
        (uint_8*)(&(event->errors)));
    return;
}
...
)
{
    ...
    if(status == (0x00))
    {
        ...
        status |= _usb_device_register_service(controller_ID,
            (0x10), USB_Reset_Service);
        status |= _usb_device_register_service(controller_ID,
            (0x12),USB_Sof_Service);
        status |= _usb_device_register_service(controller_ID,
            (0x14),USB_Suspend_Service);
        status |= _usb_device_register_service(controller_ID,
            (0x13),USB_Resume_Service);
        status |= _usb_device_register_service(controller_ID,
            (0x17),USB_Stall_Service);
        status |= _usb_device_register_service(controller_ID,
            (0x16),USB_Error_Service);

         
        (void)_usb_device_set_status(&controller_ID,
            (0x01),(0x03));
        g_device_state_before_suspend = (0x03);
    }
...
)
{
    ...
    status |= _usb_device_unregister_service(&controller_ID,(0x10));
    status |= _usb_device_unregister_service(&controller_ID,(0x12));
    status |= _usb_device_unregister_service(&controller_ID,(0x14));
    status |= _usb_device_unregister_service(&controller_ID,(0x13));
    status |= _usb_device_unregister_service(&controller_ID,(0x17));
    status |= _usb_device_unregister_service(&controller_ID,(0x16));
...
)
{
  ...
  (void)_usb_device_get_status(&controller_ID, (0x01), &device_state);
  (void)_usb_device_get_status(&controller_ID, (0x06), &state);
  if((device_state == (0x80)) && (state & (0x0002) ) &&
     (USB_Desc_Remote_Wakeup(controller_ID) == 1))
  {
      ...
      (void)_usb_device_set_status(&controller_ID, (0x01), (0x00));
