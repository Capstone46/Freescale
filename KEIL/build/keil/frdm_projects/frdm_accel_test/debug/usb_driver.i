#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"
...
#line 39 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"
...
#line 40 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"
...
#line 41 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"

#line 1 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\USB_Config.h"
...
#line 80 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\USB_Config.h"

#line 89 "..\\..\\..\\..\\src\\drivers\\usbd\\usb_api\\usb_hid\\USB_Config.h"
...
#line 44 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"
...
extern void USB_NULL_CALLBACK (PTR_USB_DEV_EVENT_STRUCT event);
	...
	static USB_SERVICE_CALLBACK g_usb_CB[(0x18)] = {
		USB_Control_Service,
		USB_Service_Hid,
		USB_NULL_CALLBACK,
		USB_NULL_CALLBACK,
...
static uint_8 g_usb_component_status[(0x07)];
 
static uint_8 g_usb_ep_status[((0x04) + 1)];
...
static void USB_Device_Init_Params(void)
{
    ...
    for(loop_index = 0; loop_index < (0x07); loop_index++)
    {



         {
          g_usb_component_status[loop_index] = (0xFF);
         }
    }

     
    for(loop_index = 0; loop_index < ((0x04) + 1); loop_index++)
    {
        g_usb_ep_status[loop_index] = (5);
    }
}
...
)
{
    ...
    if((number_of_endpoints > ((0x04) + 1)) || (number_of_endpoints < (1)))
    {
        return (0x99);
    }
...
)
{
    ...
    if ((ep_str.ep_num != (0)) && (status == (0x00)))
    {
        g_EPn--;
    }
...
)
{
    ...
    if((g_EPn == g_EPn_max) && (endpoint_number != (0)))
    {
        return (0x96);
    }
    ...
    if ((endpoint_number != (0)) && (status == (0x00)))
    {
        g_EPn++;
    }
...
)
{
    ...
    uint_8 ep_num = (uint_8)(component & (0x0F));
    (void)handle;
    ...
    else if ((component & (0x10)) && (ep_num < ((0x04) + 1)))
    {
...
)
{
        ...
        (ep_num < ((0x04) + 1)))
    {
        ...
        if(setting == (1))
        {
            ...
            (g_usb_ep_status[ep_num] == (1)))
        {
        	_usb_device_unstall_endpoint(handle, ep_num, direction);

            if(ep_num == (0))
            {
                direction = (uint_8)((direction == (1)) ? ((0)):((1)));
                _usb_device_unstall_endpoint(handle, ep_num, direction);
            }
        }
...
)
{
    (void)controller_ID;
    (void)service;
#line 513 "..\\..\\..\\..\\src\\drivers\\usbd\\hal\\usb_driver.c"
    (void)type;;
    return (0x00);
...
)
{
    ...
    if(((event_endpoint  <= (0x04)) ||
        ((event_endpoint < (0x18)) && 
        (event_endpoint >= (0x10)))) &&
        (g_usb_CB[event_endpoint] != 0))
    {
