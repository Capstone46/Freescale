...
#line 16 "..\\..\\..\\..\\src\\drivers\\lptmr\\lptmr.c"
...
#line 17 "..\\..\\..\\..\\src\\drivers\\lptmr\\lptmr.c"



 
static LPTMR_CALLBACK pCallbackLPTMR=0;
...
{ 
  if (pCallback != 0) { pCallbackLPTMR = pCallback; { ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= (uint32)(1 << ((INT_LPTMR0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= (uint32)(1 << ((INT_LPTMR0)-16)); ((((NVIC_MemMapPtr)0xE000E100u))->IP[(uint16)(((INT_LPTMR0)-16)>>2)]) |= (uint32)((uint32)(ip)<<(uint16)(((((INT_LPTMR0)-16)%4)<<3)+6)); }; }
  ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = lptmr.PSR; 
  ((((LPTMR_MemMapPtr)0x40040000u))->CMR) = compValue;
  ((((LPTMR_MemMapPtr)0x40040000u))->CSR) = (lptmr.CSR | 0x80u); 
}
...
{ 
  ...
  if (pCallbackLPTMR != (LPTMR_CALLBACK)0) { pCallbackLPTMR (); }
}
