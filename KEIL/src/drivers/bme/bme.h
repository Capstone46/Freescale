 ...
 * Revision History:
 * 1.	16/02/2013    R55013    Initally written.
 * 1.	26/11/2013    R55013    Changed to BME.
 ******************************************************************************/
#ifndef __BME_H
#define __BME_H    
...
#define IO_AND(sz,reg,val)                                                    \
  *((uint##sz*)((IO_GPIO_TRS(&reg))|0x04000000))=(uint##sz)(val)
#define IO_OR(sz,reg,val)                                                     \
  *((uint##sz*)((IO_GPIO_TRS(&reg))|0x08000000))=(uint##sz)(val)
#define IO_XOR(sz,reg,val)                                                    \
  *((uint##sz*)((IO_GPIO_TRS(&reg))|0x0C000000))=(uint##sz)(val)
#define IO_BFI(sz,reg,shift,width,val)                                        \
  *((uint##sz*)((IO_GPIO_TRS(&reg))|0x10000000|(shift<<23)|((width-1)<<19)))= \
  ((uint##sz)(val)<<shift)
#define IO_LAC1(sz,reg,shift)                                                 \
  (uint8)(*((uint##sz*)((IO_GPIO_TRS(&reg))|0x08000000|(shift<<21))))
#define IO_LAS1(sz,reg,shift)                                                 \
  (uint8)(*((uint##sz*)((IO_GPIO_TRS(&reg))|0x0C000000|(shift<<21))))
 ...
 * @warning The logical operation is accelerated by the Bit Manipulation Engine 
 *          (BME), if address of the destination peripheral register <c>reg</c> 
 *          is from 0x40000000 to 0x4007FFFF, or it is emulated by software.
 ******************************************************************************/
 ...
 *          <c>reg</c>.
 * @param   reg     byte (16-bit) peripheral register.
 ...
 * @param   reg     byte (32-bit) peripheral register.
