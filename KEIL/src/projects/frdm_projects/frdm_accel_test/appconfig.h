...
/*******************************************************************************
*//*! @addtogroup frdm_accel_test_config_def
* @{
*******************************************************************************/
 ...
 *****************************************************************************/
#define SIM_MODULE_CONFIG_FRDM_ACCEL_CONFIG                /* all clocks on */  \
(tSIM){                                                                         \
 ...
 *****************************************************************************/
#define PORT_MODULE_ALT5_PULLUP_MODE                   /* ALT6 pullup mode */  \
(tPORT){                                                                       \
...
extern void portcd_isr (void);  ///< portcd isr prototype (defined in gpio.c)

#undef  VECTOR_038
#define VECTOR_038 pit_isr      ///< pit_isr interrupt vector re-definition

#undef  VECTOR_047
#define VECTOR_047 portcd_isr    ///< uart2_isr interrupt vector re-definition

#undef  CONFIG_4
#define CONFIG_4 (pointer*)0xffff3bfe ///< FOPT - BOOT SRC FLASH
/*! @} End of frdm_accel_test_config_def                                           */
