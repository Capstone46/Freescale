...
**
**     Reference manual:    KL33PxxxM48SF4RM, Rev.1, May 2014
**     Version:             rev. 1.1, 2014-05-26
**     Build:               b140528
**
**     Abstract:
**         This header file implements peripheral memory map for MKL33Z4
**         processor.
**
 ...
 * @version 1.1
 * @date 2014-05-26
 * @brief Peripheral memory map for MKL33Z4
 *
 * This header file implements peripheral memory map for MKL33Z4 processor.
 */
...
#if !defined(MCU_MKL33Z4)  /* Check if memory map has not been already included */
#define MCU_MKL33Z4
...
typedef enum {
  ...
  INT_UART0_FLEXIO             = 30,               /**< UART0 or FLEXIO */
...
#define SIM_SOPT5_UART0ODE_MASK                  0x40000u
#define SIM_SOPT5_UART0ODE_SHIFT                 18
/* SOPT7 Bit Fields */
...
#define SIM_SCGC4_UART0_MASK                     0x1000u
#define SIM_SCGC4_UART0_SHIFT                    12
...
#define UART0_BASE_PTR                           ((UART_MemMapPtr)0x4006C000u)
