...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL27Z4
**         processor.
**
 ...
 * @version 1.1
 * @date 2014-05-26
 * @brief Peripheral memory map for MKL27Z4
 *
 * This header file implements peripheral memory map for MKL27Z4 processor.
 */
...
#if !defined(MCU_MKL27Z4)  /* Check if memory map has not been already included */
#define MCU_MKL27Z4
