...
**
**     Reference manual:    KL17PxxMxxSF4RM, Rev.1, May 2014
**     Version:             rev. 1.1, 2014-05-26
**     Build:               b140528
**
**     Abstract:
**         This header file implements peripheral memory map for MKL17Z4
**         processor.
**
 ...
 * @version 1.1
 * @date 2014-05-26
 * @brief Peripheral memory map for MKL17Z4
 *
 * This header file implements peripheral memory map for MKL17Z4 processor.
 */
...
#if !defined(MCU_MKL17Z4)  /* Check if memory map has not been already included */
#define MCU_MKL17Z4
